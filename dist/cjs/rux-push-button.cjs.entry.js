...
const RuxPushButton = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { "aria-checked": `${checked}`, "aria-hidden": disabled ? 'true' : null, role: "switch" }, index.h("input", { class: "rux-push-button__input", id: this.pushButtonId, type: "checkbox", disabled: disabled, checked: checked, onChange: _onChange, onBlur: _onBlur, value: value }), index.h("label", { part: "container", class: {
      ...
      }, htmlFor: this.pushButtonId }, icon ? (index.h("rux-icon", { size: "auto", exportparts: "icon", icon: icon })) : null, label), index.h("slot", null)));
  }
