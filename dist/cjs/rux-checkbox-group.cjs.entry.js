...
const RuxCheckboxGroup = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: "rux-form-field", part: "form-field" }, index.h("div", { class: {
        'rux-label': true,
      ...
      }, part: "container" }, index.h("slot", null))), index.h("div", { class: {
...
exports.rux_checkbox_group = RuxCheckboxGroup;
