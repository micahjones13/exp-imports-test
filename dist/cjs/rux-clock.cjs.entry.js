...
const index$3 = require('./index-21b709f7.js');
...
function getDayOfYear(dirtyDate) {
  ...
  var diff = index$1.differenceInCalendarDays(date, startOfYear(date));
...
const RuxClock = class {
  ...
  _formatTime(time, timezone) {
    return index$3.format(index$3.utcToZonedTime(time, timezone), `HH:mm:ss ${this.hideTimezone ? '' : this.tzFormat}`, { timeZone: timezone });
  }
  _handleDateIn() {
  ...
  _updateTime() {
    if (this.dateIn) {
      if (!this.hasRun) {
        ...
        const clockDate = index$3.utcToZonedTime(this._rawTime, this._timezone);
      ...
      const clockDate = index$3.utcToZonedTime(localDate, this._timezone);
      this.dayOfYear = getDayOfYear(clockDate);
    }
  }
  /**
  ...
  _formatLosAosDateIn(dateTime) {
    ...
    return index$3.format(index$3.utcToZonedTime(dateTime, this._timezone), 'HH:mm:ss');
  }
  ...
  render() {
    return (index$2.h(index$2.Host, null, index$2.h("div", { class: "rux-clock", part: "container" }, !this.hideDate && (index$2.h("div", { class: "rux-clock__segment" }, index$2.h("div", { class: "rux-clock__segment__value", "aria-labelledby": "rux-clock__day-of-year-label", part: "date" }, this.dayOfYear.toString().padStart(3, '0')), !this.hideLabels && (index$2.h("div", { class: "rux-clock__segment__label", id: "rux-clock__day-of-year-label", part: "date-label" }, "Date")))), index$2.h("div", { class: "rux-clock__segment" }, index$2.h("div", { class: "rux-clock__segment__value", "aria-labelledby": "rux-clock__time-label", part: "time" }, this.time), !this.hideLabels && (index$2.h("div", { class: "rux-clock__segment__label", id: "rux-clock__time-label", part: "time-label" }, "Time"))), this.aos && (index$2.h("div", { class: "rux-clock__segment rux-clock__aos" }, index$2.h("div", { class: "rux-clock__segment__value", "aria-labelledby": "rux-clock__time-label--aos", id: "rux-clock__time--aos", part: "aos" }, this.convertedAos), !this.hideLabels && (index$2.h("div", { class: "rux-clock__segment__label", id: "rux-clock__time-label--aos", part: "aos-label" }, "AOS")))), this.los && (index$2.h("div", { class: "rux-clock__segment rux-clock__los" }, index$2.h("div", { class: "rux-clock__segment__value", "aria-labelledby": "rux-clock__time-label--los", id: "rux-clock__time--los", part: "los" }, this.convertedLos), !this.hideLabels && (index$2.h("div", { class: "rux-clock__segment__label", id: "rux-clock__time-label--los", part: "los-label" }, "LOS")))))));
  }
