...
const MonitoringLabel = require('./MonitoringLabel-be121a20.js');
...
const RuxMonitoringProgressIcon = class {
  ...
  render() {
    return (index.h("div", { id: "rux-advanced-status__icon", class: "rux-advanced-status", part: "container" }, index.h("div", { class: "rux-advanced-status__icon-group", part: "icon-group" }, index.h("rux-status", { status: this._status, part: "status-icon" }), index.h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 128 128", class: `rux-status--${this._status}`, part: "radial-progress" }, index.h("g", { id: "progress" }, index.h("circle", { cx: "60", cy: "60", r: "56", fill: "transparent", stroke: "rgba(40, 63, 88, 1)", "stroke-width": "10", transform: "rotate(-90 61 60)" }), index.h("circle", { cx: "60", cy: "60", r: "56", fill: "transparent", "stroke-dasharray": "351.8583772 351.8583772", "stroke-dashoffset": this._graphProgress, "stroke-linecap": "round", "stroke-width": "10", class: "progress-ring__circle", transform: "rotate(-90 61 60)" }))), index.h("div", { class: "rux-advanced-status__progress", part: "progress-display" }, Math.ceil(((this.progress - this.min) /
      (this.max - this.min)) *
      100), "%"), index.h(MonitoringLabel.MonitoringBadge, { notifications: this.notifications })), index.h(MonitoringLabel.MonitoringLabel, { label: this.label, sublabel: this.sublabel })));
  }
...
exports.rux_monitoring_progress_icon = RuxMonitoringProgressIcon;
