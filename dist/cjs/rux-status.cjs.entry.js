...
const RuxStatus = class {
  ...
  render() {
    return (index.h(index.Host, { status: this.status }, index.h("div", { part: "status", class: "status-wrapper", innerHTML: this.status && StatusSVG[this.status] })));
  }
