...
const RuxProgress = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("progress", { class: "rux-progress", value: this.value, max: this.max, part: "progress" }), index.h("output", { class: "rux-progress__value", hidden: this.hideLabel, part: "output" }, this._getProgressAsString()), index.h("slot", null)));
  }
...
exports.rux_progress = RuxProgress;
