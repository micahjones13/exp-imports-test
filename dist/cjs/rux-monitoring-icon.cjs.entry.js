...
const RuxMonitoringIcon = class {
  ...
  render() {
    return (index.h("div", { id: "rux-advanced-status__icon", class: "rux-advanced-status", part: "container" }, index.h("div", { class: "rux-advanced-status__icon-group" }, index.h("div", { class: "rux-advanced-status__status" }, index.h("rux-status", { status: this.status, part: "status-icon" })), index.h("rux-icon", { icon: this.icon, class: `rux-status--${this.status}`, size: "2.5rem", exportparts: "icon" }), index.h(MonitoringLabel.MonitoringBadge, { notifications: this.notifications })), index.h(MonitoringLabel.MonitoringLabel, { label: this.label, sublabel: this.sublabel })));
  }
...
exports.rux_monitoring_icon = RuxMonitoringIcon;
