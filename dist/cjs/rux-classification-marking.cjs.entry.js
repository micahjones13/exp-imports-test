...
const RuxClassificationMarking = class {
  constructor(hostRef) {
     ...
     */
    this.tag = false;
    this.isWrapper = utils.hasSlot(this.el);
  }
  _handleSlotChange() {
    this.isWrapper = utils.hasSlot(this.el);
  }
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: {
      ...
      }, part: "tag header" }, this._getDisplayData(), label), index.h("slot", null), isWrapper && !tag && (index.h("div", { class: {
        'rux-classification': true,
        'rux-classification--banner': type === 'banner',
...
exports.rux_classification_marking = RuxClassificationMarking;
