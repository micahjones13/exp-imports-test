...
const RuxRadioGroup = class {
  ...
  render() {
    ...
    if (this.value) {
      utils.renderHiddenInput(true, this.el, this.name, this.value, this._selectedRadioIsDisabled());
    }
    return (index.h(index.Host, { onClick: this._handleClick }, index.h("div", { class: "rux-form-field", part: "form-field" }, index.h("div", { class: {
        'rux-label': true,
        hidden: !this.hasLabel,
      }, part: "label" }, index.h("slot", { onSlotchange: this._handleSlotChange, name: "label" }, this.label, this.required && (index.h("span", { part: "required", class: "rux-label__asterisk" }, "*")))), index.h("div", { class: {
        'rux-radio-group': true,
        'rux-radio-group--invalid': this.invalid,
      }, role: "radiogroup", part: "radiogroup" }, index.h("slot", null))), index.h("div", { class: {
...
exports.rux_radio_group = RuxRadioGroup;
