...
const RuxInput = class {
  ...
  render() {
    ...
    utils.renderHiddenInput(true, el, name, value, disabled);
    return (index.h(index.Host, null, index.h("div", { class: "rux-form-field", part: "form-field" }, hasLabel ? (index.h("label", { class: {
      ...
      }, part: "label", "aria-hidden": hasLabel ? 'false' : 'true', htmlFor: inputId }, index.h("span", { class: {
        hidden: !hasLabel,
      } }, index.h("slot", { name: "label", onSlotchange: _handleSlotChange }, label, required && (index.h("span", { part: "required", class: "rux-input-label__asterisk" }, "*")))))) : null, index.h("div", { part: "input-field", class: {
        'rux-input': true,
      ...
      } }, index.h("span", { part: "prefix", class: "rux-input-prefix" }, index.h("slot", { name: "prefix" })), index.h("input", { name: name, disabled: disabled, ref: (el) => (this.inputEl = el), type: type === 'password' && this.isPasswordVisible
        ? 'text'
        : type, "aria-invalid": invalid ? 'true' : 'false', placeholder: placeholder, required: required, step: step, min: min, max: max, value: value, class: "native-input", id: inputId, spellcheck: spellcheck, readonly: readonly, onChange: _onChange, onInput: _onInput, onBlur: _onBlur, onFocus: _onFocus, part: "input" }), togglePassword ? (index.h("button", { onClick: _handleTogglePassword, class: "pw-button" }, index.h("rux-icon", { exportparts: "icon", icon: isPasswordVisible
        ? 'visibility-off'
        : 'visibility', size: "22px" }))) : null, index.h("span", { part: "suffix", class: "rux-input-suffix" }, index.h("slot", { name: "suffix" })))), index.h("div", { class: {
...
exports.rux_datetime = RuxDatetime;
exports.rux_input = RuxInput;
exports.rux_table = RuxTable;
exports.rux_table_body = RuxTableBody;
exports.rux_table_cell = RuxTableCell;
exports.rux_table_header = RuxTableHeader;
exports.rux_table_header_cell = RuxTableHeaderCell;
exports.rux_table_header_row = RuxTableHeaderRow;
exports.rux_table_row = RuxTableRow;
