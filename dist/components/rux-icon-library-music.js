...
const RuxIconLibraryMusic$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-library-music"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-library-music":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconLibraryMusic$1);
      }
      break;
  } });
}

const RuxIconLibraryMusic = RuxIconLibraryMusic$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconLibraryMusic, defineCustomElement };
