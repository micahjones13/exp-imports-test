...
const RuxIconLocalCarWash$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-local-car-wash"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-local-car-wash":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconLocalCarWash$1);
      }
      break;
  } });
}

const RuxIconLocalCarWash = RuxIconLocalCarWash$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconLocalCarWash, defineCustomElement };
