...
const RuxIconVerticalAlignCenter$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
}, [0, "rux-icon-vertical-align-center", {
    "size": [1]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-vertical-align-center"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-vertical-align-center":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconVerticalAlignCenter$1);
      }
      break;
  } });
}

const RuxIconVerticalAlignCenter = RuxIconVerticalAlignCenter$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconVerticalAlignCenter, defineCustomElement };
