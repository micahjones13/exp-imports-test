...
const RuxIconGroupWork$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-group-work"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-group-work":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconGroupWork$1);
      }
      break;
  } });
}

const RuxIconGroupWork = RuxIconGroupWork$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconGroupWork, defineCustomElement };
