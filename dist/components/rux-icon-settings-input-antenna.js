...
const RuxIconSettingsInputAntenna$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
}, [0, "rux-icon-settings-input-antenna", {
    "size": [1]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-settings-input-antenna"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-settings-input-antenna":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconSettingsInputAntenna$1);
      }
      break;
  } });
}

const RuxIconSettingsInputAntenna = RuxIconSettingsInputAntenna$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconSettingsInputAntenna, defineCustomElement };
