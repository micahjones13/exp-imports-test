...
const RuxIconRouter$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-router"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-router":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconRouter$1);
      }
      break;
  } });
}

const RuxIconRouter = RuxIconRouter$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconRouter, defineCustomElement };
