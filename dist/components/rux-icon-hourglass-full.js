...
const RuxIconHourglassFull$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-hourglass-full"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-hourglass-full":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconHourglassFull$1);
      }
      break;
  } });
}

const RuxIconHourglassFull = RuxIconHourglassFull$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconHourglassFull, defineCustomElement };
