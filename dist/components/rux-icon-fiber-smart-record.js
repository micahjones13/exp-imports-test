...
const RuxIconFiberSmartRecord$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-fiber-smart-record"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-fiber-smart-record":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconFiberSmartRecord$1);
      }
      break;
  } });
}

const RuxIconFiberSmartRecord = RuxIconFiberSmartRecord$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconFiberSmartRecord, defineCustomElement };
