...
const RuxIconAirlineSeatReclineNormal$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
}, [0, "rux-icon-airline-seat-recline-normal", {
    "size": [1]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-airline-seat-recline-normal"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-airline-seat-recline-normal":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconAirlineSeatReclineNormal$1);
      }
      break;
  } });
}

const RuxIconAirlineSeatReclineNormal = RuxIconAirlineSeatReclineNormal$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconAirlineSeatReclineNormal, defineCustomElement };
