...
const RuxIconSortByAlpha$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-sort-by-alpha"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-sort-by-alpha":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconSortByAlpha$1);
      }
      break;
  } });
}

const RuxIconSortByAlpha = RuxIconSortByAlpha$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconSortByAlpha, defineCustomElement };
