...
const RuxIconFormatAlignJustify$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
}, [0, "rux-icon-format-align-justify", {
    "size": [1]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-format-align-justify"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-format-align-justify":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconFormatAlignJustify$1);
      }
      break;
  } });
}

const RuxIconFormatAlignJustify = RuxIconFormatAlignJustify$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconFormatAlignJustify, defineCustomElement };
