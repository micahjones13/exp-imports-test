...
const RuxIconLinkedCamera$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-linked-camera"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-linked-camera":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconLinkedCamera$1);
      }
      break;
  } });
}

const RuxIconLinkedCamera = RuxIconLinkedCamera$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconLinkedCamera, defineCustomElement };
