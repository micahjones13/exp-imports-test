...
const RuxIconWhatshot$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-whatshot"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-whatshot":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconWhatshot$1);
      }
      break;
  } });
}

const RuxIconWhatshot = RuxIconWhatshot$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconWhatshot, defineCustomElement };
