...
const RuxIconAlarmOff$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-alarm-off"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-alarm-off":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconAlarmOff$1);
      }
      break;
  } });
}

const RuxIconAlarmOff = RuxIconAlarmOff$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconAlarmOff, defineCustomElement };
