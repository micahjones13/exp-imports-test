...
const RuxIconSignalWifi2Bar$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-signal-wifi-2-bar"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-signal-wifi-2-bar":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconSignalWifi2Bar$1);
      }
      break;
  } });
}

const RuxIconSignalWifi2Bar = RuxIconSignalWifi2Bar$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconSignalWifi2Bar, defineCustomElement };
