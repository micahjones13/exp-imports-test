...
const RuxIconShoppingCart$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-shopping-cart"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-shopping-cart":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconShoppingCart$1);
      }
      break;
  } });
}

const RuxIconShoppingCart = RuxIconShoppingCart$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconShoppingCart, defineCustomElement };
