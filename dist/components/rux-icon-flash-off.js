...
const RuxIconFlashOff$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-flash-off"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-flash-off":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconFlashOff$1);
      }
      break;
  } });
}

const RuxIconFlashOff = RuxIconFlashOff$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconFlashOff, defineCustomElement };
