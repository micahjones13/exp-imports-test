...
const RuxIconEqualizer$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-equalizer"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-equalizer":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconEqualizer$1);
      }
      break;
  } });
}

const RuxIconEqualizer = RuxIconEqualizer$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconEqualizer, defineCustomElement };
