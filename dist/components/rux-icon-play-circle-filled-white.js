...
const RuxIconPlayCircleFilledWhite$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
}, [0, "rux-icon-play-circle-filled-white", {
    "size": [1]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-play-circle-filled-white"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-play-circle-filled-white":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconPlayCircleFilledWhite$1);
      }
      break;
  } });
}

const RuxIconPlayCircleFilledWhite = RuxIconPlayCircleFilledWhite$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconPlayCircleFilledWhite, defineCustomElement };
