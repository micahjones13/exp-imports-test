...
const RuxIconVpnLock$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-vpn-lock"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-vpn-lock":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconVpnLock$1);
      }
      break;
  } });
}

const RuxIconVpnLock = RuxIconVpnLock$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconVpnLock, defineCustomElement };
