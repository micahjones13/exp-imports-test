...
const RuxIconAlbum$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-album"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-album":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconAlbum$1);
      }
      break;
  } });
}

const RuxIconAlbum = RuxIconAlbum$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconAlbum, defineCustomElement };
