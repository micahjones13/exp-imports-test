...
const RuxIconInsertPhoto$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-insert-photo"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-insert-photo":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconInsertPhoto$1);
      }
      break;
  } });
}

const RuxIconInsertPhoto = RuxIconInsertPhoto$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconInsertPhoto, defineCustomElement };
