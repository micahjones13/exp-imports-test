...
const RuxIconCameraFront$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-camera-front"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-camera-front":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconCameraFront$1);
      }
      break;
  } });
}

const RuxIconCameraFront = RuxIconCameraFront$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconCameraFront, defineCustomElement };
