...
const RuxIconFilterVintage$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-filter-vintage"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-filter-vintage":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconFilterVintage$1);
      }
      break;
  } });
}

const RuxIconFilterVintage = RuxIconFilterVintage$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconFilterVintage, defineCustomElement };
