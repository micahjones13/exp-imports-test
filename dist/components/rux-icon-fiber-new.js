...
const RuxIconFiberNew$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-fiber-new"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-fiber-new":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconFiberNew$1);
      }
      break;
  } });
}

const RuxIconFiberNew = RuxIconFiberNew$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconFiberNew, defineCustomElement };
