...
const RuxIconVolumeOff$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-volume-off"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-volume-off":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconVolumeOff$1);
      }
      break;
  } });
}

const RuxIconVolumeOff = RuxIconVolumeOff$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconVolumeOff, defineCustomElement };
