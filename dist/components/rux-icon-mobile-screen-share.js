...
const RuxIconMobileScreenShare$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
}, [0, "rux-icon-mobile-screen-share", {
    "size": [1]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-mobile-screen-share"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-mobile-screen-share":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconMobileScreenShare$1);
      }
      break;
  } });
}

const RuxIconMobileScreenShare = RuxIconMobileScreenShare$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconMobileScreenShare, defineCustomElement };
