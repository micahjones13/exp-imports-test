...
const RuxIconSettingsCell$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-settings-cell"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-settings-cell":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconSettingsCell$1);
      }
      break;
  } });
}

const RuxIconSettingsCell = RuxIconSettingsCell$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconSettingsCell, defineCustomElement };
