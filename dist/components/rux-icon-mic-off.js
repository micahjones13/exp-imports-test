...
const RuxIconMicOff$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-mic-off"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-mic-off":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconMicOff$1);
      }
      break;
  } });
}

const RuxIconMicOff = RuxIconMicOff$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconMicOff, defineCustomElement };
