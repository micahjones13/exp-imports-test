...
const RuxIconControlPointDuplicate$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-control-point-duplicate"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-control-point-duplicate":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconControlPointDuplicate$1);
      }
      break;
  } });
}

const RuxIconControlPointDuplicate = RuxIconControlPointDuplicate$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconControlPointDuplicate, defineCustomElement };
