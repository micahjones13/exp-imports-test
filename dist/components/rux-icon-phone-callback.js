...
const RuxIconPhoneCallback$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-phone-callback"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-phone-callback":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconPhoneCallback$1);
      }
      break;
  } });
}

const RuxIconPhoneCallback = RuxIconPhoneCallback$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconPhoneCallback, defineCustomElement };
