...
const RuxIconFormatListNumberedRtl$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
}, [0, "rux-icon-format-list-numbered-rtl", {
    "size": [1]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-format-list-numbered-rtl"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-format-list-numbered-rtl":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconFormatListNumberedRtl$1);
      }
      break;
  } });
}

const RuxIconFormatListNumberedRtl = RuxIconFormatListNumberedRtl$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconFormatListNumberedRtl, defineCustomElement };
