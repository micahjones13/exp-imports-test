...
const RuxIconAutorenew$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-autorenew"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-autorenew":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconAutorenew$1);
      }
      break;
  } });
}

const RuxIconAutorenew = RuxIconAutorenew$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconAutorenew, defineCustomElement };
