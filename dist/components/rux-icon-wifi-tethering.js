...
const RuxIconWifiTethering$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-wifi-tethering"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-wifi-tethering":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconWifiTethering$1);
      }
      break;
  } });
}

const RuxIconWifiTethering = RuxIconWifiTethering$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconWifiTethering, defineCustomElement };
