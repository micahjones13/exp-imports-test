...
const RuxIconBrightnessLow$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-brightness-low"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-brightness-low":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconBrightnessLow$1);
      }
      break;
  } });
}

const RuxIconBrightnessLow = RuxIconBrightnessLow$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconBrightnessLow, defineCustomElement };
