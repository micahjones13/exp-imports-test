...
const RuxIconBrightnessHigh$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-brightness-high"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-brightness-high":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconBrightnessHigh$1);
      }
      break;
  } });
}

const RuxIconBrightnessHigh = RuxIconBrightnessHigh$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconBrightnessHigh, defineCustomElement };
