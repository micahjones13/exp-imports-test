...
const RuxIconFindInPage$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-find-in-page"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-find-in-page":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconFindInPage$1);
      }
      break;
  } });
}

const RuxIconFindInPage = RuxIconFindInPage$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconFindInPage, defineCustomElement };
