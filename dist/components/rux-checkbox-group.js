...
const RuxCheckboxGroup$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  get el() { return this; }
  static get style() { return ruxCheckboxGroupCss; }
}, [1, "rux-checkbox-group", {
    "label": [1],
...
function defineCustomElement$1() {
  ...
  const components = ["rux-checkbox-group"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-checkbox-group":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxCheckboxGroup$1);
      }
      break;
  } });
}

const RuxCheckboxGroup = RuxCheckboxGroup$1;
const defineCustomElement = defineCustomElement$1;

export { RuxCheckboxGroup, defineCustomElement };
