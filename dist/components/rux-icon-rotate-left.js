...
const RuxIconRotateLeft$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-rotate-left"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-rotate-left":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconRotateLeft$1);
      }
      break;
  } });
}

const RuxIconRotateLeft = RuxIconRotateLeft$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconRotateLeft, defineCustomElement };
