...
const RuxIconNoEncryption$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-no-encryption"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-no-encryption":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconNoEncryption$1);
      }
      break;
  } });
}

const RuxIconNoEncryption = RuxIconNoEncryption$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconNoEncryption, defineCustomElement };
