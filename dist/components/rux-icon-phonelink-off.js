...
const RuxIconPhonelinkOff$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-phonelink-off"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-phonelink-off":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconPhonelinkOff$1);
      }
      break;
  } });
}

const RuxIconPhonelinkOff = RuxIconPhonelinkOff$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconPhonelinkOff, defineCustomElement };
