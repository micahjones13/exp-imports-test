...
const RuxIconArchive$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-archive"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-archive":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconArchive$1);
      }
      break;
  } });
}

const RuxIconArchive = RuxIconArchive$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconArchive, defineCustomElement };
