...
const RuxIconImportExport$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-import-export"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-import-export":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconImportExport$1);
      }
      break;
  } });
}

const RuxIconImportExport = RuxIconImportExport$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconImportExport, defineCustomElement };
