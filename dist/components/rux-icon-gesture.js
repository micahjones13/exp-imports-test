...
const RuxIconGesture$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-gesture"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-gesture":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconGesture$1);
      }
      break;
  } });
}

const RuxIconGesture = RuxIconGesture$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconGesture, defineCustomElement };
