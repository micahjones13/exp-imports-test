...
const RuxIconDvr$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-dvr"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-dvr":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconDvr$1);
      }
      break;
  } });
}

const RuxIconDvr = RuxIconDvr$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconDvr, defineCustomElement };
