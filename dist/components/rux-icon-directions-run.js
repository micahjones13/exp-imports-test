...
const RuxIconDirectionsRun$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-directions-run"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-directions-run":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconDirectionsRun$1);
      }
      break;
  } });
}

const RuxIconDirectionsRun = RuxIconDirectionsRun$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconDirectionsRun, defineCustomElement };
