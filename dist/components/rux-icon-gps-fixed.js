...
const RuxIconGpsFixed$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-gps-fixed"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-gps-fixed":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconGpsFixed$1);
      }
      break;
  } });
}

const RuxIconGpsFixed = RuxIconGpsFixed$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconGpsFixed, defineCustomElement };
