...
const RuxIconPartyMode$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-party-mode"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-party-mode":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconPartyMode$1);
      }
      break;
  } });
}

const RuxIconPartyMode = RuxIconPartyMode$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconPartyMode, defineCustomElement };
