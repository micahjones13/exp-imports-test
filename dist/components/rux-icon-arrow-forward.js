...
const RuxIconArrowForward$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-arrow-forward"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-arrow-forward":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconArrowForward$1);
      }
      break;
  } });
}

const RuxIconArrowForward = RuxIconArrowForward$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconArrowForward, defineCustomElement };
