...
const RuxIconComputer$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-computer"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-computer":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconComputer$1);
      }
      break;
  } });
}

const RuxIconComputer = RuxIconComputer$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconComputer, defineCustomElement };
