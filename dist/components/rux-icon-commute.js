...
const RuxIconCommute$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-commute"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-commute":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconCommute$1);
      }
      break;
  } });
}

const RuxIconCommute = RuxIconCommute$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconCommute, defineCustomElement };
