...
const RuxIconBugReport$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-bug-report"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-bug-report":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconBugReport$1);
      }
      break;
  } });
}

const RuxIconBugReport = RuxIconBugReport$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconBugReport, defineCustomElement };
