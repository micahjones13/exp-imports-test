...
const RuxIconDirections$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-directions"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-directions":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconDirections$1);
      }
      break;
  } });
}

const RuxIconDirections = RuxIconDirections$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconDirections, defineCustomElement };
