...
const RuxIconPermCameraMic$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-perm-camera-mic"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-perm-camera-mic":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconPermCameraMic$1);
      }
      break;
  } });
}

const RuxIconPermCameraMic = RuxIconPermCameraMic$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconPermCameraMic, defineCustomElement };
