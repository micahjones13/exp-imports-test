...
const RuxIconAccessAlarms$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-access-alarms"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-access-alarms":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconAccessAlarms$1);
      }
      break;
  } });
}

const RuxIconAccessAlarms = RuxIconAccessAlarms$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconAccessAlarms, defineCustomElement };
