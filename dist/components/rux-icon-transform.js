...
const RuxIconTransform$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-transform"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-transform":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconTransform$1);
      }
      break;
  } });
}

const RuxIconTransform = RuxIconTransform$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconTransform, defineCustomElement };
