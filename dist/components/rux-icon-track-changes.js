...
const RuxIconTrackChanges$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-track-changes"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-track-changes":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconTrackChanges$1);
      }
      break;
  } });
}

const RuxIconTrackChanges = RuxIconTrackChanges$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconTrackChanges, defineCustomElement };
