...
const RuxIconBatteryStd$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-battery-std"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-battery-std":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconBatteryStd$1);
      }
      break;
  } });
}

const RuxIconBatteryStd = RuxIconBatteryStd$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconBatteryStd, defineCustomElement };
