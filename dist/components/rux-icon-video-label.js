...
const RuxIconVideoLabel$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-video-label"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-video-label":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconVideoLabel$1);
      }
      break;
  } });
}

const RuxIconVideoLabel = RuxIconVideoLabel$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconVideoLabel, defineCustomElement };
