...
const RuxIconLineStyle$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-line-style"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-line-style":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconLineStyle$1);
      }
      break;
  } });
}

const RuxIconLineStyle = RuxIconLineStyle$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconLineStyle, defineCustomElement };
