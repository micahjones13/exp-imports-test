...
const RuxIconUnfoldMore$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-unfold-more"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-unfold-more":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconUnfoldMore$1);
      }
      break;
  } });
}

const RuxIconUnfoldMore = RuxIconUnfoldMore$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconUnfoldMore, defineCustomElement };
