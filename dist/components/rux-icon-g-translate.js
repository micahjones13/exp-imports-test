...
const RuxIconGTranslate$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-g-translate"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-g-translate":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconGTranslate$1);
      }
      break;
  } });
}

const RuxIconGTranslate = RuxIconGTranslate$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconGTranslate, defineCustomElement };
