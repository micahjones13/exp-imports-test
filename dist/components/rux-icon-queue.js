...
const RuxIconQueue$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-queue"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-queue":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconQueue$1);
      }
      break;
  } });
}

const RuxIconQueue = RuxIconQueue$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconQueue, defineCustomElement };
