...
const RuxIconSpellcheck$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-spellcheck"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-spellcheck":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconSpellcheck$1);
      }
      break;
  } });
}

const RuxIconSpellcheck = RuxIconSpellcheck$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconSpellcheck, defineCustomElement };
