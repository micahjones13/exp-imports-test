...
const RuxIconAccountBalance$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-account-balance"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-account-balance":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconAccountBalance$1);
      }
      break;
  } });
}

const RuxIconAccountBalance = RuxIconAccountBalance$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconAccountBalance, defineCustomElement };
