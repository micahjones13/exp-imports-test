...
const RuxIconWifi$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-wifi"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-wifi":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconWifi$1);
      }
      break;
  } });
}

const RuxIconWifi = RuxIconWifi$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconWifi, defineCustomElement };
