...
const RuxIconGridOff$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-grid-off"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-grid-off":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconGridOff$1);
      }
      break;
  } });
}

const RuxIconGridOff = RuxIconGridOff$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconGridOff, defineCustomElement };
