...
const RuxIconGroupAdd$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-group-add"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-group-add":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconGroupAdd$1);
      }
      break;
  } });
}

const RuxIconGroupAdd = RuxIconGroupAdd$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconGroupAdd, defineCustomElement };
