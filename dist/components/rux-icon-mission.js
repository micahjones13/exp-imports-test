...
const RuxIconMission$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-mission"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-mission":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconMission$1);
      }
      break;
  } });
}

const RuxIconMission = RuxIconMission$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconMission, defineCustomElement };
