...
const RuxIconAccessibleForward$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-accessible-forward"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-accessible-forward":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconAccessibleForward$1);
      }
      break;
  } });
}

const RuxIconAccessibleForward = RuxIconAccessibleForward$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconAccessibleForward, defineCustomElement };
