...
const RuxIconReplay10$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-replay-10"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-replay-10":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconReplay10$1);
      }
      break;
  } });
}

const RuxIconReplay10 = RuxIconReplay10$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconReplay10, defineCustomElement };
