...
const RuxIconBatteryCharging30$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
}, [0, "rux-icon-battery-charging-30", {
    "size": [1]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-battery-charging-30"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-battery-charging-30":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconBatteryCharging30$1);
      }
      break;
  } });
}

const RuxIconBatteryCharging30 = RuxIconBatteryCharging30$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconBatteryCharging30, defineCustomElement };
