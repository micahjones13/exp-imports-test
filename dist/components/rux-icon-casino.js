...
const RuxIconCasino$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-casino"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-casino":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconCasino$1);
      }
      break;
  } });
}

const RuxIconCasino = RuxIconCasino$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconCasino, defineCustomElement };
