...
const RuxIconPictureInPictureAlt$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
}, [0, "rux-icon-picture-in-picture-alt", {
    "size": [1]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-picture-in-picture-alt"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-picture-in-picture-alt":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconPictureInPictureAlt$1);
      }
      break;
  } });
}

const RuxIconPictureInPictureAlt = RuxIconPictureInPictureAlt$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconPictureInPictureAlt, defineCustomElement };
