...
const RuxIconPanoramaVertical$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-panorama-vertical"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-panorama-vertical":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconPanoramaVertical$1);
      }
      break;
  } });
}

const RuxIconPanoramaVertical = RuxIconPanoramaVertical$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconPanoramaVertical, defineCustomElement };
