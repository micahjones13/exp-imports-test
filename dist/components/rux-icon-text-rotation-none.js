...
const RuxIconTextRotationNone$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-text-rotation-none"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-text-rotation-none":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconTextRotationNone$1);
      }
      break;
  } });
}

const RuxIconTextRotationNone = RuxIconTextRotationNone$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconTextRotationNone, defineCustomElement };
