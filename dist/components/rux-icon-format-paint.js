...
const RuxIconFormatPaint$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-format-paint"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-format-paint":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconFormatPaint$1);
      }
      break;
  } });
}

const RuxIconFormatPaint = RuxIconFormatPaint$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconFormatPaint, defineCustomElement };
