...
const RuxIconBrightness3$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-brightness-3"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-brightness-3":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconBrightness3$1);
      }
      break;
  } });
}

const RuxIconBrightness3 = RuxIconBrightness3$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconBrightness3, defineCustomElement };
