...
const RuxIconClose$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-close"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-close":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconClose$1);
      }
      break;
  } });
}

const RuxIconClose = RuxIconClose$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconClose, defineCustomElement };
