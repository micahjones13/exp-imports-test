...
const RuxIconHelp$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-help"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-help":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconHelp$1);
      }
      break;
  } });
}

const RuxIconHelp = RuxIconHelp$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconHelp, defineCustomElement };
