...
const RuxIconFilter8$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-filter-8"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-filter-8":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconFilter8$1);
      }
      break;
  } });
}

const RuxIconFilter8 = RuxIconFilter8$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconFilter8, defineCustomElement };
