...
const RuxIconSpeakerPhone$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-speaker-phone"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-speaker-phone":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconSpeakerPhone$1);
      }
      break;
  } });
}

const RuxIconSpeakerPhone = RuxIconSpeakerPhone$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconSpeakerPhone, defineCustomElement };
