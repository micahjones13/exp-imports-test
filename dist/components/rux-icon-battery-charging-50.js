...
const RuxIconBatteryCharging50$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
}, [0, "rux-icon-battery-charging-50", {
    "size": [1]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-battery-charging-50"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-battery-charging-50":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconBatteryCharging50$1);
      }
      break;
  } });
}

const RuxIconBatteryCharging50 = RuxIconBatteryCharging50$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconBatteryCharging50, defineCustomElement };
