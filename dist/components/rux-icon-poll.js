...
const RuxIconPoll$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-poll"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-poll":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconPoll$1);
      }
      break;
  } });
}

const RuxIconPoll = RuxIconPoll$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconPoll, defineCustomElement };
