...
const RuxIconAirlineSeatLegroomExtra$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
}, [0, "rux-icon-airline-seat-legroom-extra", {
    "size": [1]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-airline-seat-legroom-extra"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-airline-seat-legroom-extra":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconAirlineSeatLegroomExtra$1);
      }
      break;
  } });
}

const RuxIconAirlineSeatLegroomExtra = RuxIconAirlineSeatLegroomExtra$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconAirlineSeatLegroomExtra, defineCustomElement };
