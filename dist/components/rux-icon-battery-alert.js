...
const RuxIconBatteryAlert$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-battery-alert"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-battery-alert":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconBatteryAlert$1);
      }
      break;
  } });
}

const RuxIconBatteryAlert = RuxIconBatteryAlert$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconBatteryAlert, defineCustomElement };
