...
const RuxIconSentimentSatisfiedAlt$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
}, [0, "rux-icon-sentiment-satisfied-alt", {
    "size": [1]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-sentiment-satisfied-alt"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-sentiment-satisfied-alt":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconSentimentSatisfiedAlt$1);
      }
      break;
  } });
}

const RuxIconSentimentSatisfiedAlt = RuxIconSentimentSatisfiedAlt$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconSentimentSatisfiedAlt, defineCustomElement };
