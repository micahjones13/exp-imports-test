...
const RuxIconDeviceUnknown$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-device-unknown"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-device-unknown":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconDeviceUnknown$1);
      }
      break;
  } });
}

const RuxIconDeviceUnknown = RuxIconDeviceUnknown$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconDeviceUnknown, defineCustomElement };
