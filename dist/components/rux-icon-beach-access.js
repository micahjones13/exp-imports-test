...
const RuxIconBeachAccess$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-beach-access"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-beach-access":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconBeachAccess$1);
      }
      break;
  } });
}

const RuxIconBeachAccess = RuxIconBeachAccess$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconBeachAccess, defineCustomElement };
