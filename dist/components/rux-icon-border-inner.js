...
const RuxIconBorderInner$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-border-inner"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-border-inner":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconBorderInner$1);
      }
      break;
  } });
}

const RuxIconBorderInner = RuxIconBorderInner$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconBorderInner, defineCustomElement };
