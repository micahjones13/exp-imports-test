...
const RuxIconMonetizationOn$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-monetization-on"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-monetization-on":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconMonetizationOn$1);
      }
      break;
  } });
}

const RuxIconMonetizationOn = RuxIconMonetizationOn$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconMonetizationOn, defineCustomElement };
