...
const RuxIconHearing$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-hearing"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-hearing":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconHearing$1);
      }
      break;
  } });
}

const RuxIconHearing = RuxIconHearing$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconHearing, defineCustomElement };
