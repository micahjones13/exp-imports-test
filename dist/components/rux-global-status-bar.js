...
const AppMeta = ({ domain, name, version }, children) => (h("div", { class: "app-meta", part: "app-meta" },
  h("div", { class: "app-info-wrapper" },
    domain && h("h1", { class: "app-domain" }, domain),
    name && h("h1", { class: "app-name" }, name),
    version && h("span", { class: "app-version" }, version)),
  children));
...
const RuxGlobalStatusBar$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return ruxGlobalStatusBarCss; }
}, [1, "rux-global-status-bar", {
    "includeIcon": [4, "include-icon"],
    "appState": [1, "app-state"],
    "appStateColor": [1, "app-state-color"],
    "username": [1],
    "appDomain": [1, "app-domain"],
    "appName": [1, "app-name"],
    "appVersion": [1, "app-version"],
    "menuIcon": [513, "menu-icon"]
  }]);
function defineCustomElement$1() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["rux-global-status-bar", "rux-icon"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-global-status-bar":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxGlobalStatusBar$1);
      }
      break;
    case "rux-icon":
      if (!customElements.get(tagName)) {
...
const RuxGlobalStatusBar = RuxGlobalStatusBar$1;
const defineCustomElement = defineCustomElement$1;

export { RuxGlobalStatusBar, defineCustomElement };
