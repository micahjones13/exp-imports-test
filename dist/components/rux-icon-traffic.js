...
const RuxIconTraffic$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-traffic"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-traffic":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconTraffic$1);
      }
      break;
  } });
}

const RuxIconTraffic = RuxIconTraffic$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconTraffic, defineCustomElement };
