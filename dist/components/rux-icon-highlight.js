...
const RuxIconHighlight$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-highlight"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-highlight":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconHighlight$1);
      }
      break;
  } });
}

const RuxIconHighlight = RuxIconHighlight$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconHighlight, defineCustomElement };
