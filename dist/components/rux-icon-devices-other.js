...
const RuxIconDevicesOther$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-devices-other"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-devices-other":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconDevicesOther$1);
      }
      break;
  } });
}

const RuxIconDevicesOther = RuxIconDevicesOther$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconDevicesOther, defineCustomElement };
