...
const RuxIconRadio$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-radio"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-radio":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconRadio$1);
      }
      break;
  } });
}

const RuxIconRadio = RuxIconRadio$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconRadio, defineCustomElement };
