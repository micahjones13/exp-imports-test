...
const RuxIconBlurLinear$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-blur-linear"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-blur-linear":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconBlurLinear$1);
      }
      break;
  } });
}

const RuxIconBlurLinear = RuxIconBlurLinear$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconBlurLinear, defineCustomElement };
