...
const RuxIconSignalCellularConnectedNoInternet2Bar$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
}, [0, "rux-icon-signal-cellular-connected-no-internet-2-bar", {
    "size": [1]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-signal-cellular-connected-no-internet-2-bar"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-signal-cellular-connected-no-internet-2-bar":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconSignalCellularConnectedNoInternet2Bar$1);
      }
      break;
  } });
}

const RuxIconSignalCellularConnectedNoInternet2Bar = RuxIconSignalCellularConnectedNoInternet2Bar$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconSignalCellularConnectedNoInternet2Bar, defineCustomElement };
