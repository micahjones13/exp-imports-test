...
const RuxIconDialerSip$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-dialer-sip"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-dialer-sip":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconDialerSip$1);
      }
      break;
  } });
}

const RuxIconDialerSip = RuxIconDialerSip$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconDialerSip, defineCustomElement };
