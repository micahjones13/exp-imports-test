...
const RuxIconAddPhotoAlternate$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
}, [0, "rux-icon-add-photo-alternate", {
    "size": [1]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-add-photo-alternate"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-add-photo-alternate":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconAddPhotoAlternate$1);
      }
      break;
  } });
}

const RuxIconAddPhotoAlternate = RuxIconAddPhotoAlternate$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconAddPhotoAlternate, defineCustomElement };
