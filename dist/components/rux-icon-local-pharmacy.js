...
const RuxIconLocalPharmacy$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-local-pharmacy"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-local-pharmacy":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconLocalPharmacy$1);
      }
      break;
  } });
}

const RuxIconLocalPharmacy = RuxIconLocalPharmacy$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconLocalPharmacy, defineCustomElement };
