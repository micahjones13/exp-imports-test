...
const RuxIconReplyAll$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-reply-all"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-reply-all":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconReplyAll$1);
      }
      break;
  } });
}

const RuxIconReplyAll = RuxIconReplyAll$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconReplyAll, defineCustomElement };
