...
const RuxIconLocationCity$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-location-city"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-location-city":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconLocationCity$1);
      }
      break;
  } });
}

const RuxIconLocationCity = RuxIconLocationCity$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconLocationCity, defineCustomElement };
