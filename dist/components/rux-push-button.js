...
const RuxPushButton$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  get el() { return this; }
  static get style() { return ruxPushButtonCss; }
}, [1, "rux-push-button", {
    "icon": [513],
...
function defineCustomElement$1() {
  ...
  const components = ["rux-push-button", "rux-icon"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-push-button":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxPushButton$1);
      }
      break;
    case "rux-icon":
      if (!customElements.get(tagName)) {
...
const RuxPushButton = RuxPushButton$1;
const defineCustomElement = defineCustomElement$1;

export { RuxPushButton, defineCustomElement };
