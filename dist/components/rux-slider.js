...
let id = 0;
const RuxSlider$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return ruxSliderCss; }
}, [1, "rux-slider", {
    "min": [2],
    "max": [2],
    "step": [2],
...
function defineCustomElement$1() {
  ...
  const components = ["rux-slider"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-slider":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxSlider$1);
      }
      break;
  } });
}

const RuxSlider = RuxSlider$1;
const defineCustomElement = defineCustomElement$1;

export { RuxSlider, defineCustomElement };
