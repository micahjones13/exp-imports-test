...
const RuxIconMovieCreation$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-movie-creation"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-movie-creation":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconMovieCreation$1);
      }
      break;
  } });
}

const RuxIconMovieCreation = RuxIconMovieCreation$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconMovieCreation, defineCustomElement };
