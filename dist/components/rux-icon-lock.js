...
const RuxIconLock$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-lock"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-lock":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconLock$1);
      }
      break;
  } });
}

const RuxIconLock = RuxIconLock$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconLock, defineCustomElement };
