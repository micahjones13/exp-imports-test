...
const RuxIconSettingsEthernet$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-settings-ethernet"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-settings-ethernet":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconSettingsEthernet$1);
      }
      break;
  } });
}

const RuxIconSettingsEthernet = RuxIconSettingsEthernet$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconSettingsEthernet, defineCustomElement };
