...
const RuxIconCloudOff$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-cloud-off"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-cloud-off":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconCloudOff$1);
      }
      break;
  } });
}

const RuxIconCloudOff = RuxIconCloudOff$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconCloudOff, defineCustomElement };
