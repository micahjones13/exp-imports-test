...
const RuxIconPower$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-power"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-power":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconPower$1);
      }
      break;
  } });
}

const RuxIconPower = RuxIconPower$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconPower, defineCustomElement };
