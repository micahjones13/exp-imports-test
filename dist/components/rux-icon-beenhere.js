...
const RuxIconBeenhere$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-beenhere"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-beenhere":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconBeenhere$1);
      }
      break;
  } });
}

const RuxIconBeenhere = RuxIconBeenhere$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconBeenhere, defineCustomElement };
