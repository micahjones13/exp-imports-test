...
const RuxIconHdrStrong$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-hdr-strong"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-hdr-strong":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconHdrStrong$1);
      }
      break;
  } });
}

const RuxIconHdrStrong = RuxIconHdrStrong$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconHdrStrong, defineCustomElement };
