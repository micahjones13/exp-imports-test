...
const RuxIconCalendarViewDay$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-calendar-view-day"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-calendar-view-day":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconCalendarViewDay$1);
      }
      break;
  } });
}

const RuxIconCalendarViewDay = RuxIconCalendarViewDay$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconCalendarViewDay, defineCustomElement };
