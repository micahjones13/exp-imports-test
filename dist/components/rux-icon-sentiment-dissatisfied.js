...
const RuxIconSentimentDissatisfied$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-sentiment-dissatisfied"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-sentiment-dissatisfied":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconSentimentDissatisfied$1);
      }
      break;
  } });
}

const RuxIconSentimentDissatisfied = RuxIconSentimentDissatisfied$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconSentimentDissatisfied, defineCustomElement };
