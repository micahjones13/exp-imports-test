...
const RuxIconSnooze$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-snooze"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-snooze":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconSnooze$1);
      }
      break;
  } });
}

const RuxIconSnooze = RuxIconSnooze$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconSnooze, defineCustomElement };
