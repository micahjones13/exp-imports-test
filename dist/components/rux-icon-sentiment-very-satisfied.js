...
const RuxIconSentimentVerySatisfied$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
}, [0, "rux-icon-sentiment-very-satisfied", {
    "size": [1]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-sentiment-very-satisfied"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-sentiment-very-satisfied":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconSentimentVerySatisfied$1);
      }
      break;
  } });
}

const RuxIconSentimentVerySatisfied = RuxIconSentimentVerySatisfied$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconSentimentVerySatisfied, defineCustomElement };
