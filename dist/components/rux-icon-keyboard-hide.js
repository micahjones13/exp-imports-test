...
const RuxIconKeyboardHide$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-keyboard-hide"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-keyboard-hide":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconKeyboardHide$1);
      }
      break;
  } });
}

const RuxIconKeyboardHide = RuxIconKeyboardHide$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconKeyboardHide, defineCustomElement };
