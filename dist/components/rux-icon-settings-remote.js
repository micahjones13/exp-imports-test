...
const RuxIconSettingsRemote$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-settings-remote"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-settings-remote":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconSettingsRemote$1);
      }
      break;
  } });
}

const RuxIconSettingsRemote = RuxIconSettingsRemote$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconSettingsRemote, defineCustomElement };
