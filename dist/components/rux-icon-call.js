...
const RuxIconCall$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-call"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-call":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconCall$1);
      }
      break;
  } });
}

const RuxIconCall = RuxIconCall$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconCall, defineCustomElement };
