...
const RuxIconAlarm$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-alarm"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-alarm":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconAlarm$1);
      }
      break;
  } });
}

const RuxIconAlarm = RuxIconAlarm$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconAlarm, defineCustomElement };
