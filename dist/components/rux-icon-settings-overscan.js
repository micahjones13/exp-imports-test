...
const RuxIconSettingsOverscan$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-settings-overscan"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-settings-overscan":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconSettingsOverscan$1);
      }
      break;
  } });
}

const RuxIconSettingsOverscan = RuxIconSettingsOverscan$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconSettingsOverscan, defineCustomElement };
