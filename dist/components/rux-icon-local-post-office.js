...
const RuxIconLocalPostOffice$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-local-post-office"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-local-post-office":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconLocalPostOffice$1);
      }
      break;
  } });
}

const RuxIconLocalPostOffice = RuxIconLocalPostOffice$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconLocalPostOffice, defineCustomElement };
