...
const RuxIconPlace$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-place"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-place":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconPlace$1);
      }
      break;
  } });
}

const RuxIconPlace = RuxIconPlace$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconPlace, defineCustomElement };
