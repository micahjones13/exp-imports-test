...
const RuxIconSupervisedUserCircle$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
}, [0, "rux-icon-supervised-user-circle", {
    "size": [1]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-supervised-user-circle"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-supervised-user-circle":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconSupervisedUserCircle$1);
      }
      break;
  } });
}

const RuxIconSupervisedUserCircle = RuxIconSupervisedUserCircle$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconSupervisedUserCircle, defineCustomElement };
