...
const RuxIconAddAlarm$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-add-alarm"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-add-alarm":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconAddAlarm$1);
      }
      break;
  } });
}

const RuxIconAddAlarm = RuxIconAddAlarm$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconAddAlarm, defineCustomElement };
