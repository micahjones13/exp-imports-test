...
const RuxTab$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  get el() { return this; }
  static get style() { return ruxTabCss; }
}, [1, "rux-tab", {
    "selected": [516],
    "disabled": [516],
    "small": [4]
...
function defineCustomElement$1() {
  ...
  const components = ["rux-tab"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-tab":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxTab$1);
      }
      break;
  } });
}

const RuxTab = RuxTab$1;
const defineCustomElement = defineCustomElement$1;

export { RuxTab, defineCustomElement };
