...
const RuxIconRotateRight$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-rotate-right"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-rotate-right":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconRotateRight$1);
      }
      break;
  } });
}

const RuxIconRotateRight = RuxIconRotateRight$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconRotateRight, defineCustomElement };
