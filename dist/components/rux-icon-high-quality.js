...
const RuxIconHighQuality$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-high-quality"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-high-quality":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconHighQuality$1);
      }
      break;
  } });
}

const RuxIconHighQuality = RuxIconHighQuality$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconHighQuality, defineCustomElement };
