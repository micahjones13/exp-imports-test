...
const RuxIconFlip$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-flip"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-flip":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconFlip$1);
      }
      break;
  } });
}

const RuxIconFlip = RuxIconFlip$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconFlip, defineCustomElement };
