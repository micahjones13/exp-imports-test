...
const RuxIconBlurOn$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-blur-on"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-blur-on":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconBlurOn$1);
      }
      break;
  } });
}

const RuxIconBlurOn = RuxIconBlurOn$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconBlurOn, defineCustomElement };
