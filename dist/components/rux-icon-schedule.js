...
const RuxIconSchedule$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-schedule"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-schedule":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconSchedule$1);
      }
      break;
  } });
}

const RuxIconSchedule = RuxIconSchedule$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconSchedule, defineCustomElement };
