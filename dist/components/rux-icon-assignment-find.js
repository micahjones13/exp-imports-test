...
const RuxIconAssignmentFind$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-assignment-find"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-assignment-find":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconAssignmentFind$1);
      }
      break;
  } });
}

const RuxIconAssignmentFind = RuxIconAssignmentFind$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconAssignmentFind, defineCustomElement };
