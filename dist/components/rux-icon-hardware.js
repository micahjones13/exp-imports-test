...
const RuxIconHardware$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-hardware"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-hardware":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconHardware$1);
      }
      break;
  } });
}

const RuxIconHardware = RuxIconHardware$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconHardware, defineCustomElement };
