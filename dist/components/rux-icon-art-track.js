...
const RuxIconArtTrack$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-art-track"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-art-track":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconArtTrack$1);
      }
      break;
  } });
}

const RuxIconArtTrack = RuxIconArtTrack$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconArtTrack, defineCustomElement };
