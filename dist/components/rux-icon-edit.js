...
const RuxIconEdit$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-edit"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-edit":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconEdit$1);
      }
      break;
  } });
}

const RuxIconEdit = RuxIconEdit$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconEdit, defineCustomElement };
