...
const RuxIconHd$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-hd"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-hd":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconHd$1);
      }
      break;
  } });
}

const RuxIconHd = RuxIconHd$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconHd, defineCustomElement };
