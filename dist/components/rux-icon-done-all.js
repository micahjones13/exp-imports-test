...
const RuxIconDoneAll$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-done-all"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-done-all":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconDoneAll$1);
      }
      break;
  } });
}

const RuxIconDoneAll = RuxIconDoneAll$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconDoneAll, defineCustomElement };
