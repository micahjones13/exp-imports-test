...
const RuxIconAddAPhoto$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-add-a-photo"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-add-a-photo":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconAddAPhoto$1);
      }
      break;
  } });
}

const RuxIconAddAPhoto = RuxIconAddAPhoto$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconAddAPhoto, defineCustomElement };
