...
const RuxIconAssistantPhoto$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-assistant-photo"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-assistant-photo":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconAssistantPhoto$1);
      }
      break;
  } });
}

const RuxIconAssistantPhoto = RuxIconAssistantPhoto$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconAssistantPhoto, defineCustomElement };
