...
const RuxIconSurroundSound$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-surround-sound"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-surround-sound":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconSurroundSound$1);
      }
      break;
  } });
}

const RuxIconSurroundSound = RuxIconSurroundSound$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconSurroundSound, defineCustomElement };
