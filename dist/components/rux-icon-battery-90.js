...
const RuxIconBattery90$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-battery-90"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-battery-90":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconBattery90$1);
      }
      break;
  } });
}

const RuxIconBattery90 = RuxIconBattery90$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconBattery90, defineCustomElement };
