...
const RuxIconDialpad$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-dialpad"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-dialpad":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconDialpad$1);
      }
      break;
  } });
}

const RuxIconDialpad = RuxIconDialpad$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconDialpad, defineCustomElement };
