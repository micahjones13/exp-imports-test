...
const RuxIconPauseCircleFilled$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
}, [0, "rux-icon-pause-circle-filled", {
    "size": [1]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-pause-circle-filled"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-pause-circle-filled":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconPauseCircleFilled$1);
      }
      break;
  } });
}

const RuxIconPauseCircleFilled = RuxIconPauseCircleFilled$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconPauseCircleFilled, defineCustomElement };
