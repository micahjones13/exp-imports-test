...
const RuxIconAllOut$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-all-out"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-all-out":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconAllOut$1);
      }
      break;
  } });
}

const RuxIconAllOut = RuxIconAllOut$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconAllOut, defineCustomElement };
