...
const RuxIconAntennaTransmit$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-antenna-transmit"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-antenna-transmit":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconAntennaTransmit$1);
      }
      break;
  } });
}

const RuxIconAntennaTransmit = RuxIconAntennaTransmit$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconAntennaTransmit, defineCustomElement };
