...
const RuxRadioGroup$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return ruxRadioGroupCss; }
}, [1, "rux-radio-group", {
    "label": [1],
    "invalid": [4],
    "required": [4],
...
function defineCustomElement$1() {
  ...
  const components = ["rux-radio-group"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-radio-group":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxRadioGroup$1);
      }
      break;
  } });
}

const RuxRadioGroup = RuxRadioGroup$1;
const defineCustomElement = defineCustomElement$1;

export { RuxRadioGroup, defineCustomElement };
