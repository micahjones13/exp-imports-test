...
const RuxIconStyle$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-style"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-style":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconStyle$1);
      }
      break;
  } });
}

const RuxIconStyle = RuxIconStyle$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconStyle, defineCustomElement };
