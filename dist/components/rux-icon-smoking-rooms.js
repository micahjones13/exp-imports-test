...
const RuxIconSmokingRooms$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-smoking-rooms"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-smoking-rooms":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconSmokingRooms$1);
      }
      break;
  } });
}

const RuxIconSmokingRooms = RuxIconSmokingRooms$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconSmokingRooms, defineCustomElement };
