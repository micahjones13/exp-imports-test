...
const RuxIconPictureInPicture$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-picture-in-picture"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-picture-in-picture":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconPictureInPicture$1);
      }
      break;
  } });
}

const RuxIconPictureInPicture = RuxIconPictureInPicture$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconPictureInPicture, defineCustomElement };
