...
const RuxIconBatteryUnknown$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-battery-unknown"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-battery-unknown":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconBatteryUnknown$1);
      }
      break;
  } });
}

const RuxIconBatteryUnknown = RuxIconBatteryUnknown$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconBatteryUnknown, defineCustomElement };
