...
const RuxIconComment$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-comment"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-comment":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconComment$1);
      }
      break;
  } });
}

const RuxIconComment = RuxIconComment$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconComment, defineCustomElement };
