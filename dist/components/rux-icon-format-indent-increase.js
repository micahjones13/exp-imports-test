...
const RuxIconFormatIndentIncrease$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
}, [0, "rux-icon-format-indent-increase", {
    "size": [1]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-format-indent-increase"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-format-indent-increase":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconFormatIndentIncrease$1);
      }
      break;
  } });
}

const RuxIconFormatIndentIncrease = RuxIconFormatIndentIncrease$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconFormatIndentIncrease, defineCustomElement };
