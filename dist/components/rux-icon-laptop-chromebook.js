...
const RuxIconLaptopChromebook$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-laptop-chromebook"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-laptop-chromebook":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconLaptopChromebook$1);
      }
      break;
  } });
}

const RuxIconLaptopChromebook = RuxIconLaptopChromebook$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconLaptopChromebook, defineCustomElement };
