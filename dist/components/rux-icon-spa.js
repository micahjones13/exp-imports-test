...
const RuxIconSpa$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-spa"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-spa":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconSpa$1);
      }
      break;
  } });
}

const RuxIconSpa = RuxIconSpa$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconSpa, defineCustomElement };
