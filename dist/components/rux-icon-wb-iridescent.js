...
const RuxIconWbIridescent$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-wb-iridescent"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-wb-iridescent":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconWbIridescent$1);
      }
      break;
  } });
}

const RuxIconWbIridescent = RuxIconWbIridescent$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconWbIridescent, defineCustomElement };
