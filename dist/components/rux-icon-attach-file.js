...
const RuxIconAttachFile$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-attach-file"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-attach-file":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconAttachFile$1);
      }
      break;
  } });
}

const RuxIconAttachFile = RuxIconAttachFile$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconAttachFile, defineCustomElement };
