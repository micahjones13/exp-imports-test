...
const RuxIconSimCard$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-sim-card"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-sim-card":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconSimCard$1);
      }
      break;
  } });
}

const RuxIconSimCard = RuxIconSimCard$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconSimCard, defineCustomElement };
