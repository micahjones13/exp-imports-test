...
const RuxIconLaptopMac$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-laptop-mac"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-laptop-mac":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconLaptopMac$1);
      }
      break;
  } });
}

const RuxIconLaptopMac = RuxIconLaptopMac$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconLaptopMac, defineCustomElement };
