...
const RuxIconCallMerge$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-call-merge"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-call-merge":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconCallMerge$1);
      }
      break;
  } });
}

const RuxIconCallMerge = RuxIconCallMerge$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconCallMerge, defineCustomElement };
