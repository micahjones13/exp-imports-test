...
const RuxIconAirlineSeatReclineExtra$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
}, [0, "rux-icon-airline-seat-recline-extra", {
    "size": [1]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-airline-seat-recline-extra"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-airline-seat-recline-extra":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconAirlineSeatReclineExtra$1);
      }
      break;
  } });
}

const RuxIconAirlineSeatReclineExtra = RuxIconAirlineSeatReclineExtra$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconAirlineSeatReclineExtra, defineCustomElement };
