...
const RuxIconLocalPrintshop$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-local-printshop"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-local-printshop":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconLocalPrintshop$1);
      }
      break;
  } });
}

const RuxIconLocalPrintshop = RuxIconLocalPrintshop$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconLocalPrintshop, defineCustomElement };
