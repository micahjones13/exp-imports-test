...
const RuxIconHdrOff$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-hdr-off"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-hdr-off":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconHdrOff$1);
      }
      break;
  } });
}

const RuxIconHdrOff = RuxIconHdrOff$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconHdrOff, defineCustomElement };
