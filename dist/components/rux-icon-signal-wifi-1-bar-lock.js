...
const RuxIconSignalWifi1BarLock$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
}, [0, "rux-icon-signal-wifi-1-bar-lock", {
    "size": [1]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-signal-wifi-1-bar-lock"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-signal-wifi-1-bar-lock":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconSignalWifi1BarLock$1);
      }
      break;
  } });
}

const RuxIconSignalWifi1BarLock = RuxIconSignalWifi1BarLock$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconSignalWifi1BarLock, defineCustomElement };
