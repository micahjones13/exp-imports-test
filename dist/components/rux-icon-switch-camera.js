...
const RuxIconSwitchCamera$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-switch-camera"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-switch-camera":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconSwitchCamera$1);
      }
      break;
  } });
}

const RuxIconSwitchCamera = RuxIconSwitchCamera$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconSwitchCamera, defineCustomElement };
