...
const RuxIconWidgets$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-widgets"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-widgets":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconWidgets$1);
      }
      break;
  } });
}

const RuxIconWidgets = RuxIconWidgets$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconWidgets, defineCustomElement };
