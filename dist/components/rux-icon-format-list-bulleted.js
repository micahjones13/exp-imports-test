...
const RuxIconFormatListBulleted$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
}, [0, "rux-icon-format-list-bulleted", {
    "size": [1]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-format-list-bulleted"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-format-list-bulleted":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconFormatListBulleted$1);
      }
      break;
  } });
}

const RuxIconFormatListBulleted = RuxIconFormatListBulleted$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconFormatListBulleted, defineCustomElement };
