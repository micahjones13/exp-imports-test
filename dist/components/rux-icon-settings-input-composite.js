...
const RuxIconSettingsInputComposite$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
}, [0, "rux-icon-settings-input-composite", {
    "size": [1]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-settings-input-composite"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-settings-input-composite":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconSettingsInputComposite$1);
      }
      break;
  } });
}

const RuxIconSettingsInputComposite = RuxIconSettingsInputComposite$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconSettingsInputComposite, defineCustomElement };
