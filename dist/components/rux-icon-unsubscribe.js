...
const RuxIconUnsubscribe$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-unsubscribe"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-unsubscribe":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconUnsubscribe$1);
      }
      break;
  } });
}

const RuxIconUnsubscribe = RuxIconUnsubscribe$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconUnsubscribe, defineCustomElement };
