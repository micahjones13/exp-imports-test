...
const RuxIconAspectRatio$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-aspect-ratio"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-aspect-ratio":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconAspectRatio$1);
      }
      break;
  } });
}

const RuxIconAspectRatio = RuxIconAspectRatio$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconAspectRatio, defineCustomElement };
