...
const RuxIconLibraryAdd$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-library-add"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-library-add":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconLibraryAdd$1);
      }
      break;
  } });
}

const RuxIconLibraryAdd = RuxIconLibraryAdd$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconLibraryAdd, defineCustomElement };
