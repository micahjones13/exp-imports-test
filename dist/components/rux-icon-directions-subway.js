...
const RuxIconDirectionsSubway$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-directions-subway"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-directions-subway":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconDirectionsSubway$1);
      }
      break;
  } });
}

const RuxIconDirectionsSubway = RuxIconDirectionsSubway$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconDirectionsSubway, defineCustomElement };
