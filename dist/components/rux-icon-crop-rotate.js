...
const RuxIconCropRotate$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-crop-rotate"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-crop-rotate":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconCropRotate$1);
      }
      break;
  } });
}

const RuxIconCropRotate = RuxIconCropRotate$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconCropRotate, defineCustomElement };
