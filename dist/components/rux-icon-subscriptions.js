...
const RuxIconSubscriptions$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-subscriptions"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-subscriptions":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconSubscriptions$1);
      }
      break;
  } });
}

const RuxIconSubscriptions = RuxIconSubscriptions$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconSubscriptions, defineCustomElement };
