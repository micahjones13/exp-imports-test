...
const RuxIconViewArray$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-view-array"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-view-array":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconViewArray$1);
      }
      break;
  } });
}

const RuxIconViewArray = RuxIconViewArray$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconViewArray, defineCustomElement };
