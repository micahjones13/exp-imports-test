...
const RuxIconCameraRoll$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-camera-roll"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-camera-roll":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconCameraRoll$1);
      }
      break;
  } });
}

const RuxIconCameraRoll = RuxIconCameraRoll$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconCameraRoll, defineCustomElement };
