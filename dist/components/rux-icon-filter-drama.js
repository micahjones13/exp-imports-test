...
const RuxIconFilterDrama$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-filter-drama"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-filter-drama":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconFilterDrama$1);
      }
      break;
  } });
}

const RuxIconFilterDrama = RuxIconFilterDrama$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconFilterDrama, defineCustomElement };
