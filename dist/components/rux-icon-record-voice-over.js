...
const RuxIconRecordVoiceOver$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-record-voice-over"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-record-voice-over":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconRecordVoiceOver$1);
      }
      break;
  } });
}

const RuxIconRecordVoiceOver = RuxIconRecordVoiceOver$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconRecordVoiceOver, defineCustomElement };
