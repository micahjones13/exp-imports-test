...
const RuxIconNotListedLocation$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
}, [0, "rux-icon-not-listed-location", {
    "size": [1]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-not-listed-location"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-not-listed-location":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconNotListedLocation$1);
      }
      break;
  } });
}

const RuxIconNotListedLocation = RuxIconNotListedLocation$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconNotListedLocation, defineCustomElement };
