...
const RuxIconPhotoSizeSelectSmall$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
}, [0, "rux-icon-photo-size-select-small", {
    "size": [1]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-photo-size-select-small"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-photo-size-select-small":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconPhotoSizeSelectSmall$1);
      }
      break;
  } });
}

const RuxIconPhotoSizeSelectSmall = RuxIconPhotoSizeSelectSmall$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconPhotoSizeSelectSmall, defineCustomElement };
