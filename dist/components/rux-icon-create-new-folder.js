...
const RuxIconCreateNewFolder$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-create-new-folder"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-create-new-folder":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconCreateNewFolder$1);
      }
      break;
  } });
}

const RuxIconCreateNewFolder = RuxIconCreateNewFolder$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconCreateNewFolder, defineCustomElement };
