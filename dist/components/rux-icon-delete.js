...
const RuxIconDelete$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-delete"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-delete":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconDelete$1);
      }
      break;
  } });
}

const RuxIconDelete = RuxIconDelete$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconDelete, defineCustomElement };
