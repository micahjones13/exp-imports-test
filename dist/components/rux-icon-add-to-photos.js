...
const RuxIconAddToPhotos$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-add-to-photos"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-add-to-photos":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconAddToPhotos$1);
      }
      break;
  } });
}

const RuxIconAddToPhotos = RuxIconAddToPhotos$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconAddToPhotos, defineCustomElement };
