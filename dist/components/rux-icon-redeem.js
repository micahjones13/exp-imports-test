...
const RuxIconRedeem$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-redeem"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-redeem":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconRedeem$1);
      }
      break;
  } });
}

const RuxIconRedeem = RuxIconRedeem$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconRedeem, defineCustomElement };
