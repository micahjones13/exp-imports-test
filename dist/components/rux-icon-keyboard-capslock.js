...
const RuxIconKeyboardCapslock$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-keyboard-capslock"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-keyboard-capslock":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconKeyboardCapslock$1);
      }
      break;
  } });
}

const RuxIconKeyboardCapslock = RuxIconKeyboardCapslock$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconKeyboardCapslock, defineCustomElement };
