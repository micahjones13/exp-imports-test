...
const RuxIconCenterFocusStrong$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
}, [0, "rux-icon-center-focus-strong", {
    "size": [1]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-center-focus-strong"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-center-focus-strong":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconCenterFocusStrong$1);
      }
      break;
  } });
}

const RuxIconCenterFocusStrong = RuxIconCenterFocusStrong$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconCenterFocusStrong, defineCustomElement };
