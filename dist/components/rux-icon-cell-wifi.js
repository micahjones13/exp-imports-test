...
const RuxIconCellWifi$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-cell-wifi"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-cell-wifi":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconCellWifi$1);
      }
      break;
  } });
}

const RuxIconCellWifi = RuxIconCellWifi$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconCellWifi, defineCustomElement };
