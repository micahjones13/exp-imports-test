...
const RuxIconSatelliteTransmit$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-satellite-transmit"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-satellite-transmit":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconSatelliteTransmit$1);
      }
      break;
  } });
}

const RuxIconSatelliteTransmit = RuxIconSatelliteTransmit$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconSatelliteTransmit, defineCustomElement };
