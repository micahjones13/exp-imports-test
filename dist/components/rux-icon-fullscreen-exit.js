...
const RuxIconFullscreenExit$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-fullscreen-exit"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-fullscreen-exit":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconFullscreenExit$1);
      }
      break;
  } });
}

const RuxIconFullscreenExit = RuxIconFullscreenExit$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconFullscreenExit, defineCustomElement };
