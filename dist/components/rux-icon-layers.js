...
const RuxIconLayers$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-layers"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-layers":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconLayers$1);
      }
      break;
  } });
}

const RuxIconLayers = RuxIconLayers$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconLayers, defineCustomElement };
