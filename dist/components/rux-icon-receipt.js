...
const RuxIconReceipt$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-receipt"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-receipt":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconReceipt$1);
      }
      break;
  } });
}

const RuxIconReceipt = RuxIconReceipt$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconReceipt, defineCustomElement };
