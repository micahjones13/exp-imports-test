...
import { h as hasSlot, a as renderHiddenSelect } from './utils.js';
...
const RuxSelect$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return ruxSelectCss; }
}, [1, "rux-select", {
    "disabled": [516],
    "required": [516],
    "label": [1],
    ...
    "hasErrorSlot": [32],
    "setFocus": [64]
  }, [[0, "rux-option-group-changed", "handleGroupChange"], [0, "rux-option-changed", "handleOptionChange"]]]);
function defineCustomElement$1() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["rux-select"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-select":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxSelect$1);
      }
      break;
  } });
}

const RuxSelect = RuxSelect$1;
const defineCustomElement = defineCustomElement$1;

export { RuxSelect, defineCustomElement };
