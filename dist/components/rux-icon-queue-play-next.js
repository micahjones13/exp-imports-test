...
const RuxIconQueuePlayNext$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-queue-play-next"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-queue-play-next":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconQueuePlayNext$1);
      }
      break;
  } });
}

const RuxIconQueuePlayNext = RuxIconQueuePlayNext$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconQueuePlayNext, defineCustomElement };
