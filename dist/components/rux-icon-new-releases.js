...
const RuxIconNewReleases$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-new-releases"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-new-releases":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconNewReleases$1);
      }
      break;
  } });
}

const RuxIconNewReleases = RuxIconNewReleases$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconNewReleases, defineCustomElement };
