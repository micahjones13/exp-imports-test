...
const RuxIconChildFriendly$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-child-friendly"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-child-friendly":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconChildFriendly$1);
      }
      break;
  } });
}

const RuxIconChildFriendly = RuxIconChildFriendly$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconChildFriendly, defineCustomElement };
