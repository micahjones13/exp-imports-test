...
const RuxIconLocalMovies$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-local-movies"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-local-movies":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconLocalMovies$1);
      }
      break;
  } });
}

const RuxIconLocalMovies = RuxIconLocalMovies$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconLocalMovies, defineCustomElement };
