...
const RuxIconTextFormat$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-text-format"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-text-format":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconTextFormat$1);
      }
      break;
  } });
}

const RuxIconTextFormat = RuxIconTextFormat$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconTextFormat, defineCustomElement };
