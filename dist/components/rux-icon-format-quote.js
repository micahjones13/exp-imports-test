...
const RuxIconFormatQuote$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-format-quote"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-format-quote":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconFormatQuote$1);
      }
      break;
  } });
}

const RuxIconFormatQuote = RuxIconFormatQuote$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconFormatQuote, defineCustomElement };
