...
const RuxIconSentimentVeryDissatisfied$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
}, [0, "rux-icon-sentiment-very-dissatisfied", {
    "size": [1]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-sentiment-very-dissatisfied"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-sentiment-very-dissatisfied":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconSentimentVeryDissatisfied$1);
      }
      break;
  } });
}

const RuxIconSentimentVeryDissatisfied = RuxIconSentimentVeryDissatisfied$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconSentimentVeryDissatisfied, defineCustomElement };
