...
const RuxIconViewWeek$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-view-week"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-view-week":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconViewWeek$1);
      }
      break;
  } });
}

const RuxIconViewWeek = RuxIconViewWeek$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconViewWeek, defineCustomElement };
