...
const RuxIconTimer$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-timer"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-timer":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconTimer$1);
      }
      break;
  } });
}

const RuxIconTimer = RuxIconTimer$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconTimer, defineCustomElement };
