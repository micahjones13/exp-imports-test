...
const RuxIconMoodBad$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-mood-bad"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-mood-bad":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconMoodBad$1);
      }
      break;
  } });
}

const RuxIconMoodBad = RuxIconMoodBad$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconMoodBad, defineCustomElement };
