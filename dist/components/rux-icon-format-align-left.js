...
const RuxIconFormatAlignLeft$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-format-align-left"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-format-align-left":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconFormatAlignLeft$1);
      }
      break;
  } });
}

const RuxIconFormatAlignLeft = RuxIconFormatAlignLeft$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconFormatAlignLeft, defineCustomElement };
