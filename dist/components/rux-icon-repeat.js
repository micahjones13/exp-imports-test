...
const RuxIconRepeat$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-repeat"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-repeat":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconRepeat$1);
      }
      break;
  } });
}

const RuxIconRepeat = RuxIconRepeat$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconRepeat, defineCustomElement };
