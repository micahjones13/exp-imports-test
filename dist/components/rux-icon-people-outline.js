...
const RuxIconPeopleOutline$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-people-outline"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-people-outline":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconPeopleOutline$1);
      }
      break;
  } });
}

const RuxIconPeopleOutline = RuxIconPeopleOutline$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconPeopleOutline, defineCustomElement };
