...
const RuxIconBrightness4$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-brightness-4"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-brightness-4":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconBrightness4$1);
      }
      break;
  } });
}

const RuxIconBrightness4 = RuxIconBrightness4$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconBrightness4, defineCustomElement };
