...
const RuxIconDirectionsBoat$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-directions-boat"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-directions-boat":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconDirectionsBoat$1);
      }
      break;
  } });
}

const RuxIconDirectionsBoat = RuxIconDirectionsBoat$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconDirectionsBoat, defineCustomElement };
