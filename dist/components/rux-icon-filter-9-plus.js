...
const RuxIconFilter9Plus$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-filter-9-plus"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-filter-9-plus":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconFilter9Plus$1);
      }
      break;
  } });
}

const RuxIconFilter9Plus = RuxIconFilter9Plus$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconFilter9Plus, defineCustomElement };
