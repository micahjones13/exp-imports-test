...
const RuxIconAirplanemodeActive$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
}, [0, "rux-icon-airplanemode-active", {
    "size": [1]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-airplanemode-active"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-airplanemode-active":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconAirplanemodeActive$1);
      }
      break;
  } });
}

const RuxIconAirplanemodeActive = RuxIconAirplanemodeActive$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconAirplanemodeActive, defineCustomElement };
