...
const RuxIconSearch$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-search"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-search":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconSearch$1);
      }
      break;
  } });
}

const RuxIconSearch = RuxIconSearch$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconSearch, defineCustomElement };
