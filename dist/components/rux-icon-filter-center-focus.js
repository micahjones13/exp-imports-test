...
const RuxIconFilterCenterFocus$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
}, [0, "rux-icon-filter-center-focus", {
    "size": [1]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-filter-center-focus"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-filter-center-focus":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconFilterCenterFocus$1);
      }
      break;
  } });
}

const RuxIconFilterCenterFocus = RuxIconFilterCenterFocus$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconFilterCenterFocus, defineCustomElement };
