...
const RuxIconErrorOutline$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-error-outline"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-error-outline":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconErrorOutline$1);
      }
      break;
  } });
}

const RuxIconErrorOutline = RuxIconErrorOutline$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconErrorOutline, defineCustomElement };
