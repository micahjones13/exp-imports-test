...
const RuxIconThumbsUpDown$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-thumbs-up-down"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-thumbs-up-down":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconThumbsUpDown$1);
      }
      break;
  } });
}

const RuxIconThumbsUpDown = RuxIconThumbsUpDown$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconThumbsUpDown, defineCustomElement };
