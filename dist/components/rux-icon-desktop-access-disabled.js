...
const RuxIconDesktopAccessDisabled$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
}, [0, "rux-icon-desktop-access-disabled", {
    "size": [1]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-desktop-access-disabled"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-desktop-access-disabled":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconDesktopAccessDisabled$1);
      }
      break;
  } });
}

const RuxIconDesktopAccessDisabled = RuxIconDesktopAccessDisabled$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconDesktopAccessDisabled, defineCustomElement };
