...
const RuxIconDomainDisabled$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-domain-disabled"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-domain-disabled":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconDomainDisabled$1);
      }
      break;
  } });
}

const RuxIconDomainDisabled = RuxIconDomainDisabled$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconDomainDisabled, defineCustomElement };
