...
import { d as defineCustomElement$4 } from './rux-button2.js';
import { d as defineCustomElement$3 } from './rux-button-group2.js';
...
const RuxDialog$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return ruxDialogCss; }
}, [17, "rux-dialog", {
    "open": [1540],
    "message": [1],
    "header": [1],
    "confirmText": [1, "confirm-text"],
    "denyText": [1, "deny-text"],
    "clickToClose": [4, "click-to-close"],
    "hasFooter": [32],
    "hasHeader": [32],
    "hasMessage": [32]
  }, [[8, "keydown", "handleKeyDown"], [8, "click", "handleClick"]]]);
function defineCustomElement$1() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["rux-dialog", "rux-button", "rux-button-group", "rux-icon"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-dialog":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxDialog$1);
      }
      break;
    case "rux-button":
      if (!customElements.get(tagName)) {
...
const RuxDialog = RuxDialog$1;
const defineCustomElement = defineCustomElement$1;

export { RuxDialog, defineCustomElement };
