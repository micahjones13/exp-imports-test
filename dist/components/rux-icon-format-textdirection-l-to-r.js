...
const RuxIconFormatTextdirectionLToR$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
}, [0, "rux-icon-format-textdirection-l-to-r", {
    "size": [1]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-format-textdirection-l-to-r"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-format-textdirection-l-to-r":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconFormatTextdirectionLToR$1);
      }
      break;
  } });
}

const RuxIconFormatTextdirectionLToR = RuxIconFormatTextdirectionLToR$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconFormatTextdirectionLToR, defineCustomElement };
