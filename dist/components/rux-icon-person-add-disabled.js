...
const RuxIconPersonAddDisabled$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
}, [0, "rux-icon-person-add-disabled", {
    "size": [1]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-person-add-disabled"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-person-add-disabled":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconPersonAddDisabled$1);
      }
      break;
  } });
}

const RuxIconPersonAddDisabled = RuxIconPersonAddDisabled$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconPersonAddDisabled, defineCustomElement };
