...
const RuxIconInsertChartOutlined$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-insert-chart-outlined"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-insert-chart-outlined":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconInsertChartOutlined$1);
      }
      break;
  } });
}

const RuxIconInsertChartOutlined = RuxIconInsertChartOutlined$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconInsertChartOutlined, defineCustomElement };
