...
const RuxIconWhereToVote$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-where-to-vote"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-where-to-vote":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconWhereToVote$1);
      }
      break;
  } });
}

const RuxIconWhereToVote = RuxIconWhereToVote$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconWhereToVote, defineCustomElement };
