...
const RuxIconBorderVertical$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-border-vertical"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-border-vertical":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconBorderVertical$1);
      }
      break;
  } });
}

const RuxIconBorderVertical = RuxIconBorderVertical$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconBorderVertical, defineCustomElement };
