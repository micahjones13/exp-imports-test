...
const RuxIconAddShoppingCart$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-add-shopping-cart"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-add-shopping-cart":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconAddShoppingCart$1);
      }
      break;
  } });
}

const RuxIconAddShoppingCart = RuxIconAddShoppingCart$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconAddShoppingCart, defineCustomElement };
