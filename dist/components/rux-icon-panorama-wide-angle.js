...
const RuxIconPanoramaWideAngle$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
}, [0, "rux-icon-panorama-wide-angle", {
    "size": [1]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-panorama-wide-angle"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-panorama-wide-angle":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconPanoramaWideAngle$1);
      }
      break;
  } });
}

const RuxIconPanoramaWideAngle = RuxIconPanoramaWideAngle$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconPanoramaWideAngle, defineCustomElement };
