...
const RuxIconDragIndicator$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-drag-indicator"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-drag-indicator":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconDragIndicator$1);
      }
      break;
  } });
}

const RuxIconDragIndicator = RuxIconDragIndicator$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconDragIndicator, defineCustomElement };
