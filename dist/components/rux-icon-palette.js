...
const RuxIconPalette$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-palette"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-palette":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconPalette$1);
      }
      break;
  } });
}

const RuxIconPalette = RuxIconPalette$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconPalette, defineCustomElement };
