...
const RuxIconDeveloperMode$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-developer-mode"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-developer-mode":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconDeveloperMode$1);
      }
      break;
  } });
}

const RuxIconDeveloperMode = RuxIconDeveloperMode$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconDeveloperMode, defineCustomElement };
