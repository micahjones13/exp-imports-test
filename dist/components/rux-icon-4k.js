...
const RuxIcon4k$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-4k"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-4k":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIcon4k$1);
      }
      break;
  } });
}

const RuxIcon4k = RuxIcon4k$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIcon4k, defineCustomElement };
