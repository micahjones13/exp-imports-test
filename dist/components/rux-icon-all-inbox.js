...
const RuxIconAllInbox$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-all-inbox"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-all-inbox":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconAllInbox$1);
      }
      break;
  } });
}

const RuxIconAllInbox = RuxIconAllInbox$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconAllInbox, defineCustomElement };
