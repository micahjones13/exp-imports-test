...
const RuxIconLooks3$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-looks-3"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-looks-3":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconLooks3$1);
      }
      break;
  } });
}

const RuxIconLooks3 = RuxIconLooks3$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconLooks3, defineCustomElement };
