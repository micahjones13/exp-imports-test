...
const RuxIconMail$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-mail"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-mail":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconMail$1);
      }
      break;
  } });
}

const RuxIconMail = RuxIconMail$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconMail, defineCustomElement };
