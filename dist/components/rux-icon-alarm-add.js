...
const RuxIconAlarmAdd$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-alarm-add"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-alarm-add":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconAlarmAdd$1);
      }
      break;
  } });
}

const RuxIconAlarmAdd = RuxIconAlarmAdd$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconAlarmAdd, defineCustomElement };
