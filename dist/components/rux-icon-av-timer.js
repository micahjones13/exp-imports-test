...
const RuxIconAvTimer$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-av-timer"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-av-timer":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconAvTimer$1);
      }
      break;
  } });
}

const RuxIconAvTimer = RuxIconAvTimer$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconAvTimer, defineCustomElement };
