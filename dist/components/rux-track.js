...
const RuxTrack$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return ruxTrackCss; }
}, [1, "rux-track", {
    "width": [514],
    "columns": [514],
    "interval": [520],
    ...
    "end": [513],
    "timezone": [513]
  }, [[0, "ruxtimeregionchange", "handleTimeRegionChange"]]]);
function defineCustomElement$1() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["rux-track"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-track":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxTrack$1);
      }
      break;
  } });
}

const RuxTrack = RuxTrack$1;
const defineCustomElement = defineCustomElement$1;

export { RuxTrack, defineCustomElement };
