...
const RuxIconExposureZero$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-exposure-zero"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-exposure-zero":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconExposureZero$1);
      }
      break;
  } });
}

const RuxIconExposureZero = RuxIconExposureZero$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconExposureZero, defineCustomElement };
