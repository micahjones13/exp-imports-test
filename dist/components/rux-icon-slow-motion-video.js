...
const RuxIconSlowMotionVideo$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-slow-motion-video"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-slow-motion-video":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconSlowMotionVideo$1);
      }
      break;
  } });
}

const RuxIconSlowMotionVideo = RuxIconSlowMotionVideo$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconSlowMotionVideo, defineCustomElement };
