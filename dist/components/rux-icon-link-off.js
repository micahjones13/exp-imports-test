...
const RuxIconLinkOff$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-link-off"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-link-off":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconLinkOff$1);
      }
      break;
  } });
}

const RuxIconLinkOff = RuxIconLinkOff$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconLinkOff, defineCustomElement };
