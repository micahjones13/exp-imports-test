...
const RuxIconThermal$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-thermal"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-thermal":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconThermal$1);
      }
      break;
  } });
}

const RuxIconThermal = RuxIconThermal$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconThermal, defineCustomElement };
