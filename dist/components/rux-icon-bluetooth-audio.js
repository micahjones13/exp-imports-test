...
const RuxIconBluetoothAudio$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-bluetooth-audio"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-bluetooth-audio":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconBluetoothAudio$1);
      }
      break;
  } });
}

const RuxIconBluetoothAudio = RuxIconBluetoothAudio$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconBluetoothAudio, defineCustomElement };
