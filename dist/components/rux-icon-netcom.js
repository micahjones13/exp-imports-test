...
const RuxIconNetcom$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-netcom"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-netcom":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconNetcom$1);
      }
      break;
  } });
}

const RuxIconNetcom = RuxIconNetcom$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconNetcom, defineCustomElement };
