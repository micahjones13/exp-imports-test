...
const RuxIconFilterHdr$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-filter-hdr"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-filter-hdr":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconFilterHdr$1);
      }
      break;
  } });
}

const RuxIconFilterHdr = RuxIconFilterHdr$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconFilterHdr, defineCustomElement };
