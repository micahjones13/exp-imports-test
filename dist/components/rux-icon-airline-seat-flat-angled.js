...
const RuxIconAirlineSeatFlatAngled$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
}, [0, "rux-icon-airline-seat-flat-angled", {
    "size": [1]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-airline-seat-flat-angled"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-airline-seat-flat-angled":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconAirlineSeatFlatAngled$1);
      }
      break;
  } });
}

const RuxIconAirlineSeatFlatAngled = RuxIconAirlineSeatFlatAngled$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconAirlineSeatFlatAngled, defineCustomElement };
