...
const RuxIconChevronLeft$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-chevron-left"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-chevron-left":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconChevronLeft$1);
      }
      break;
  } });
}

const RuxIconChevronLeft = RuxIconChevronLeft$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconChevronLeft, defineCustomElement };
