...
import { a as addMilliseconds, t as toInteger, d as dateRange, v as validateTimezone } from './helpers.js';
import { r as requiredArgs, t as toDate } from './index6.js';
import { g as getTimezoneOffsetInMilliseconds } from './index7.js';
import { d as differenceInMinutes } from './index4.js';
import { d as differenceInHours } from './index5.js';
...
const RuxTimeline$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return ruxTimelineCss; }
}, [1, "rux-timeline", {
    "start": [1],
    "end": [1],
    "zoom": [514],
...
function defineCustomElement$1() {
  ...
  const components = ["rux-timeline"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-timeline":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxTimeline$1);
      }
      break;
  } });
}

const RuxTimeline = RuxTimeline$1;
const defineCustomElement = defineCustomElement$1;

export { RuxTimeline, defineCustomElement };
