...
const RuxIconInvertColorsOff$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-invert-colors-off"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-invert-colors-off":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconInvertColorsOff$1);
      }
      break;
  } });
}

const RuxIconInvertColorsOff = RuxIconInvertColorsOff$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconInvertColorsOff, defineCustomElement };
