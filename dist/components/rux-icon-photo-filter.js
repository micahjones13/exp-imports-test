...
const RuxIconPhotoFilter$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-photo-filter"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-photo-filter":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconPhotoFilter$1);
      }
      break;
  } });
}

const RuxIconPhotoFilter = RuxIconPhotoFilter$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconPhotoFilter, defineCustomElement };
