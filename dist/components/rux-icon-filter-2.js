...
const RuxIconFilter2$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-filter-2"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-filter-2":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconFilter2$1);
      }
      break;
  } });
}

const RuxIconFilter2 = RuxIconFilter2$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconFilter2, defineCustomElement };
