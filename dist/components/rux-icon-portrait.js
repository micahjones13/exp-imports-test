...
const RuxIconPortrait$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-portrait"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-portrait":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconPortrait$1);
      }
      break;
  } });
}

const RuxIconPortrait = RuxIconPortrait$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconPortrait, defineCustomElement };
