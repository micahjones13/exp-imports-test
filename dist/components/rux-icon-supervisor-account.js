...
const RuxIconSupervisorAccount$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-supervisor-account"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-supervisor-account":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconSupervisorAccount$1);
      }
      break;
  } });
}

const RuxIconSupervisorAccount = RuxIconSupervisorAccount$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconSupervisorAccount, defineCustomElement };
