...
const RuxIconSubway$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-subway"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-subway":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconSubway$1);
      }
      break;
  } });
}

const RuxIconSubway = RuxIconSubway$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconSubway, defineCustomElement };
