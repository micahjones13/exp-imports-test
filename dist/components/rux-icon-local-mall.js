...
const RuxIconLocalMall$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-local-mall"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-local-mall":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconLocalMall$1);
      }
      break;
  } });
}

const RuxIconLocalMall = RuxIconLocalMall$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconLocalMall, defineCustomElement };
