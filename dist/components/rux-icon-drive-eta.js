...
const RuxIconDriveEta$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-drive-eta"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-drive-eta":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconDriveEta$1);
      }
      break;
  } });
}

const RuxIconDriveEta = RuxIconDriveEta$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconDriveEta, defineCustomElement };
