...
const RuxIconPhonelinkLock$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-phonelink-lock"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-phonelink-lock":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconPhonelinkLock$1);
      }
      break;
  } });
}

const RuxIconPhonelinkLock = RuxIconPhonelinkLock$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconPhonelinkLock, defineCustomElement };
