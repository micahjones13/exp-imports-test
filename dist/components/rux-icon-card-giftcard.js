...
const RuxIconCardGiftcard$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-card-giftcard"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-card-giftcard":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconCardGiftcard$1);
      }
      break;
  } });
}

const RuxIconCardGiftcard = RuxIconCardGiftcard$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconCardGiftcard, defineCustomElement };
