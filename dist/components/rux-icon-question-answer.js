...
const RuxIconQuestionAnswer$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-question-answer"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-question-answer":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconQuestionAnswer$1);
      }
      break;
  } });
}

const RuxIconQuestionAnswer = RuxIconQuestionAnswer$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconQuestionAnswer, defineCustomElement };
