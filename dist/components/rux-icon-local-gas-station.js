...
const RuxIconLocalGasStation$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-local-gas-station"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-local-gas-station":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconLocalGasStation$1);
      }
      break;
  } });
}

const RuxIconLocalGasStation = RuxIconLocalGasStation$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconLocalGasStation, defineCustomElement };
