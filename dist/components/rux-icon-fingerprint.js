...
const RuxIconFingerprint$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-fingerprint"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-fingerprint":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconFingerprint$1);
      }
      break;
  } });
}

const RuxIconFingerprint = RuxIconFingerprint$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconFingerprint, defineCustomElement };
