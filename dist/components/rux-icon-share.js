...
const RuxIconShare$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-share"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-share":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconShare$1);
      }
      break;
  } });
}

const RuxIconShare = RuxIconShare$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconShare, defineCustomElement };
