...
const RuxIconAddAlert$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-add-alert"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-add-alert":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconAddAlert$1);
      }
      break;
  } });
}

const RuxIconAddAlert = RuxIconAddAlert$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconAddAlert, defineCustomElement };
