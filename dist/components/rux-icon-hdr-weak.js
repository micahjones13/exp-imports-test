...
const RuxIconHdrWeak$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-hdr-weak"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-hdr-weak":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconHdrWeak$1);
      }
      break;
  } });
}

const RuxIconHdrWeak = RuxIconHdrWeak$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconHdrWeak, defineCustomElement };
