...
const RuxIconProcessor$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-processor"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-processor":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconProcessor$1);
      }
      break;
  } });
}

const RuxIconProcessor = RuxIconProcessor$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconProcessor, defineCustomElement };
