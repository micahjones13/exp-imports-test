...
const RuxIconFilter7$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-filter-7"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-filter-7":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconFilter7$1);
      }
      break;
  } });
}

const RuxIconFilter7 = RuxIconFilter7$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconFilter7, defineCustomElement };
