...
const RuxIconRecentActors$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-recent-actors"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-recent-actors":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconRecentActors$1);
      }
      break;
  } });
}

const RuxIconRecentActors = RuxIconRecentActors$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconRecentActors, defineCustomElement };
