...
const RuxIconExtension$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-extension"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-extension":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconExtension$1);
      }
      break;
  } });
}

const RuxIconExtension = RuxIconExtension$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconExtension, defineCustomElement };
