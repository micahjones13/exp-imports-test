...
const RuxIconLocalAtm$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-local-atm"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-local-atm":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconLocalAtm$1);
      }
      break;
  } });
}

const RuxIconLocalAtm = RuxIconLocalAtm$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconLocalAtm, defineCustomElement };
