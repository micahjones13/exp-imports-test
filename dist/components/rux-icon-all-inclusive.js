...
const RuxIconAllInclusive$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-all-inclusive"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-all-inclusive":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconAllInclusive$1);
      }
      break;
  } });
}

const RuxIconAllInclusive = RuxIconAllInclusive$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconAllInclusive, defineCustomElement };
