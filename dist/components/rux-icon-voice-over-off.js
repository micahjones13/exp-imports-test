...
const RuxIconVoiceOverOff$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-voice-over-off"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-voice-over-off":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconVoiceOverOff$1);
      }
      break;
  } });
}

const RuxIconVoiceOverOff = RuxIconVoiceOverOff$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconVoiceOverOff, defineCustomElement };
