...
const RuxIconRestoreFromTrash$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-restore-from-trash"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-restore-from-trash":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconRestoreFromTrash$1);
      }
      break;
  } });
}

const RuxIconRestoreFromTrash = RuxIconRestoreFromTrash$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconRestoreFromTrash, defineCustomElement };
