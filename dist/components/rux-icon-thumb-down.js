...
const RuxIconThumbDown$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-thumb-down"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-thumb-down":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconThumbDown$1);
      }
      break;
  } });
}

const RuxIconThumbDown = RuxIconThumbDown$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconThumbDown, defineCustomElement };
