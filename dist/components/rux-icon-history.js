...
const RuxIconHistory$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-history"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-history":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconHistory$1);
      }
      break;
  } });
}

const RuxIconHistory = RuxIconHistory$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconHistory, defineCustomElement };
