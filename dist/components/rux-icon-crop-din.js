...
const RuxIconCropDin$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-crop-din"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-crop-din":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconCropDin$1);
      }
      break;
  } });
}

const RuxIconCropDin = RuxIconCropDin$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconCropDin, defineCustomElement };
