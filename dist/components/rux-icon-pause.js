...
const RuxIconPause$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-pause"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-pause":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconPause$1);
      }
      break;
  } });
}

const RuxIconPause = RuxIconPause$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconPause, defineCustomElement };
