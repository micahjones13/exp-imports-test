...
const RuxIconArrowDownward$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-arrow-downward"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-arrow-downward":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconArrowDownward$1);
      }
      break;
  } });
}

const RuxIconArrowDownward = RuxIconArrowDownward$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconArrowDownward, defineCustomElement };
