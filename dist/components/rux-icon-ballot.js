...
const RuxIconBallot$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-ballot"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-ballot":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconBallot$1);
      }
      break;
  } });
}

const RuxIconBallot = RuxIconBallot$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconBallot, defineCustomElement };
