...
const RuxIconLaptopWindows$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-laptop-windows"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-laptop-windows":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconLaptopWindows$1);
      }
      break;
  } });
}

const RuxIconLaptopWindows = RuxIconLaptopWindows$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconLaptopWindows, defineCustomElement };
