...
const RuxIconLocalDining$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-local-dining"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-local-dining":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconLocalDining$1);
      }
      break;
  } });
}

const RuxIconLocalDining = RuxIconLocalDining$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconLocalDining, defineCustomElement };
