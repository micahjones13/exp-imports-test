...
const RuxIconFlightTakeoff$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-flight-takeoff"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-flight-takeoff":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconFlightTakeoff$1);
      }
      break;
  } });
}

const RuxIconFlightTakeoff = RuxIconFlightTakeoff$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconFlightTakeoff, defineCustomElement };
