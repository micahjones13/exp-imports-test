...
const RuxIconDevices$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-devices"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-devices":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconDevices$1);
      }
      break;
  } });
}

const RuxIconDevices = RuxIconDevices$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconDevices, defineCustomElement };
