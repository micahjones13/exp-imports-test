...
const RuxIconAirportShuttle$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-airport-shuttle"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-airport-shuttle":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconAirportShuttle$1);
      }
      break;
  } });
}

const RuxIconAirportShuttle = RuxIconAirportShuttle$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconAirportShuttle, defineCustomElement };
