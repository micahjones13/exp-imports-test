...
const RuxIconFlipToBack$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-flip-to-back"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-flip-to-back":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconFlipToBack$1);
      }
      break;
  } });
}

const RuxIconFlipToBack = RuxIconFlipToBack$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconFlipToBack, defineCustomElement };
