...
const RuxIconTerrain$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-terrain"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-terrain":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconTerrain$1);
      }
      break;
  } });
}

const RuxIconTerrain = RuxIconTerrain$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconTerrain, defineCustomElement };
