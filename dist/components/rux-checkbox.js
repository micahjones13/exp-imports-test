...
let id = 0;
const RuxCheckbox$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return ruxCheckboxCss; }
}, [1, "rux-checkbox", {
...
function defineCustomElement$1() {
  ...
  const components = ["rux-checkbox"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-checkbox":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxCheckbox$1);
      }
      break;
  } });
}

const RuxCheckbox = RuxCheckbox$1;
const defineCustomElement = defineCustomElement$1;

export { RuxCheckbox, defineCustomElement };
