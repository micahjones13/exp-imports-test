...
const RuxIconPortableWifiOff$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-portable-wifi-off"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-portable-wifi-off":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconPortableWifiOff$1);
      }
      break;
  } });
}

const RuxIconPortableWifiOff = RuxIconPortableWifiOff$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconPortableWifiOff, defineCustomElement };
