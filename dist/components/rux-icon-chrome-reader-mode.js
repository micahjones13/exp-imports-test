...
const RuxIconChromeReaderMode$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-chrome-reader-mode"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-chrome-reader-mode":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconChromeReaderMode$1);
      }
      break;
  } });
}

const RuxIconChromeReaderMode = RuxIconChromeReaderMode$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconChromeReaderMode, defineCustomElement };
