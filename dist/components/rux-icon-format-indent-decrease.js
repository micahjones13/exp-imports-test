...
const RuxIconFormatIndentDecrease$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
}, [0, "rux-icon-format-indent-decrease", {
    "size": [1]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-format-indent-decrease"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-format-indent-decrease":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconFormatIndentDecrease$1);
      }
      break;
  } });
}

const RuxIconFormatIndentDecrease = RuxIconFormatIndentDecrease$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconFormatIndentDecrease, defineCustomElement };
