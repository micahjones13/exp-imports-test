...
const RuxIconWatch$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-watch"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-watch":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconWatch$1);
      }
      break;
  } });
}

const RuxIconWatch = RuxIconWatch$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconWatch, defineCustomElement };
