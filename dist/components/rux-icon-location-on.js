...
const RuxIconLocationOn$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-location-on"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-location-on":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconLocationOn$1);
      }
      break;
  } });
}

const RuxIconLocationOn = RuxIconLocationOn$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconLocationOn, defineCustomElement };
