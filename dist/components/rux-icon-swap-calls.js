...
const RuxIconSwapCalls$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-swap-calls"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-swap-calls":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconSwapCalls$1);
      }
      break;
  } });
}

const RuxIconSwapCalls = RuxIconSwapCalls$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconSwapCalls, defineCustomElement };
