...
const RuxIconAddToQueue$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-add-to-queue"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-add-to-queue":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconAddToQueue$1);
      }
      break;
  } });
}

const RuxIconAddToQueue = RuxIconAddToQueue$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconAddToQueue, defineCustomElement };
