...
const RuxIconCrop54$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-crop-5-4"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-crop-5-4":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconCrop54$1);
      }
      break;
  } });
}

const RuxIconCrop54 = RuxIconCrop54$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconCrop54, defineCustomElement };
