...
const RuxIconRestore$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-restore"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-restore":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconRestore$1);
      }
      break;
  } });
}

const RuxIconRestore = RuxIconRestore$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconRestore, defineCustomElement };
