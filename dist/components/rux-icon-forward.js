...
const RuxIconForward$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-forward"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-forward":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconForward$1);
      }
      break;
  } });
}

const RuxIconForward = RuxIconForward$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconForward, defineCustomElement };
