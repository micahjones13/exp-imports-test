...
const RuxIconLocalShipping$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-local-shipping"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-local-shipping":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconLocalShipping$1);
      }
      break;
  } });
}

const RuxIconLocalShipping = RuxIconLocalShipping$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconLocalShipping, defineCustomElement };
