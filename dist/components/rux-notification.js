...
const RuxNotification$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return ruxNotificationCss; }
}, [1, "rux-notification", {
    "open": [1540],
    "message": [1],
    "status": [513],
    "closeAfter": [1026, "close-after"],
    "small": [4],
...
function defineCustomElement$1() {
  ...
  const components = ["rux-notification", "rux-icon", "rux-status"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-notification":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxNotification$1);
      }
      break;
    case "rux-icon":
      if (!customElements.get(tagName)) {
...
const RuxNotification = RuxNotification$1;
const defineCustomElement = defineCustomElement$1;

export { RuxNotification, defineCustomElement };
