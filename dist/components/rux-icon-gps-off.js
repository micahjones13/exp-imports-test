...
const RuxIconGpsOff$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-gps-off"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-gps-off":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconGpsOff$1);
      }
      break;
  } });
}

const RuxIconGpsOff = RuxIconGpsOff$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconGpsOff, defineCustomElement };
