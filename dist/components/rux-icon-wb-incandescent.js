...
const RuxIconWbIncandescent$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-wb-incandescent"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-wb-incandescent":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconWbIncandescent$1);
      }
      break;
  } });
}

const RuxIconWbIncandescent = RuxIconWbIncandescent$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconWbIncandescent, defineCustomElement };
