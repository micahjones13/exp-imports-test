...
const RuxIconTimeToLeave$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-time-to-leave"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-time-to-leave":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconTimeToLeave$1);
      }
      break;
  } });
}

const RuxIconTimeToLeave = RuxIconTimeToLeave$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconTimeToLeave, defineCustomElement };
