...
const RuxIconSettingsBluetooth$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-settings-bluetooth"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-settings-bluetooth":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconSettingsBluetooth$1);
      }
      break;
  } });
}

const RuxIconSettingsBluetooth = RuxIconSettingsBluetooth$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconSettingsBluetooth, defineCustomElement };
