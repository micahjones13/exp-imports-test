...
const RuxIconLocationSearching$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-location-searching"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-location-searching":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconLocationSearching$1);
      }
      break;
  } });
}

const RuxIconLocationSearching = RuxIconLocationSearching$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconLocationSearching, defineCustomElement };
