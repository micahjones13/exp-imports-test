...
const RuxIconHttps$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-https"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-https":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconHttps$1);
      }
      break;
  } });
}

const RuxIconHttps = RuxIconHttps$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconHttps, defineCustomElement };
