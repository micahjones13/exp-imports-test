...
const RuxIconBattery60$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-battery-60"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-battery-60":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconBattery60$1);
      }
      break;
  } });
}

const RuxIconBattery60 = RuxIconBattery60$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconBattery60, defineCustomElement };
