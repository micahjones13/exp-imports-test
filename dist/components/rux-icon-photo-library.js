...
const RuxIconPhotoLibrary$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-photo-library"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-photo-library":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconPhotoLibrary$1);
      }
      break;
  } });
}

const RuxIconPhotoLibrary = RuxIconPhotoLibrary$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconPhotoLibrary, defineCustomElement };
