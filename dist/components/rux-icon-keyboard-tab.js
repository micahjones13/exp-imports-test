...
const RuxIconKeyboardTab$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-keyboard-tab"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-keyboard-tab":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconKeyboardTab$1);
      }
      break;
  } });
}

const RuxIconKeyboardTab = RuxIconKeyboardTab$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconKeyboardTab, defineCustomElement };
