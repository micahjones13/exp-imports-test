...
const RuxContainer$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  get el() { return this; }
  static get style() { return ruxContainerCss; }
}, [1, "rux-container", {
    "activeSlots": [32]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["rux-container"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-container":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxContainer$1);
      }
      break;
  } });
}

const RuxContainer = RuxContainer$1;
const defineCustomElement = defineCustomElement$1;

export { RuxContainer, defineCustomElement };
