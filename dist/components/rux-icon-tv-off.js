...
const RuxIconTvOff$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-tv-off"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-tv-off":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconTvOff$1);
      }
      break;
  } });
}

const RuxIconTvOff = RuxIconTvOff$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconTvOff, defineCustomElement };
