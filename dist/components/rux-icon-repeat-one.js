...
const RuxIconRepeatOne$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-repeat-one"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-repeat-one":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconRepeatOne$1);
      }
      break;
  } });
}

const RuxIconRepeatOne = RuxIconRepeatOne$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconRepeatOne, defineCustomElement };
