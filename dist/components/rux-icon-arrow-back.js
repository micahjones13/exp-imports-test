...
const RuxIconArrowBack$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-arrow-back"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-arrow-back":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconArrowBack$1);
      }
      break;
  } });
}

const RuxIconArrowBack = RuxIconArrowBack$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconArrowBack, defineCustomElement };
