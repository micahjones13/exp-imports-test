...
const RuxIconZoomIn$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-zoom-in"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-zoom-in":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconZoomIn$1);
      }
      break;
  } });
}

const RuxIconZoomIn = RuxIconZoomIn$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconZoomIn, defineCustomElement };
