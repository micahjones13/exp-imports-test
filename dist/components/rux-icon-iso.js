...
const RuxIconIso$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-iso"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-iso":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconIso$1);
      }
      break;
  } });
}

const RuxIconIso = RuxIconIso$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconIso, defineCustomElement };
