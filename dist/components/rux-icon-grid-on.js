...
const RuxIconGridOn$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-grid-on"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-grid-on":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconGridOn$1);
      }
      break;
  } });
}

const RuxIconGridOn = RuxIconGridOn$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconGridOn, defineCustomElement };
