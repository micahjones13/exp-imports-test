...
let id = 0;
const RuxTreeNode$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["rux-tree-node"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-tree-node":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxTreeNode$1);
      }
      break;
  } });
}

const RuxTreeNode = RuxTreeNode$1;
const defineCustomElement = defineCustomElement$1;

export { RuxTreeNode, defineCustomElement };
