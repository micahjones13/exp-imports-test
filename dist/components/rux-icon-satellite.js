...
const RuxIconSatellite$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-satellite"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-satellite":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconSatellite$1);
      }
      break;
  } });
}

const RuxIconSatellite = RuxIconSatellite$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconSatellite, defineCustomElement };
