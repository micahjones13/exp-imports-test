...
const RuxIconFindReplace$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-find-replace"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-find-replace":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconFindReplace$1);
      }
      break;
  } });
}

const RuxIconFindReplace = RuxIconFindReplace$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconFindReplace, defineCustomElement };
