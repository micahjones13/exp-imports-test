...
const RuxIconCode$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-code"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-code":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconCode$1);
      }
      break;
  } });
}

const RuxIconCode = RuxIconCode$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconCode, defineCustomElement };
