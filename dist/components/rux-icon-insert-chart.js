...
const RuxIconInsertChart$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-insert-chart"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-insert-chart":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconInsertChart$1);
      }
      break;
  } });
}

const RuxIconInsertChart = RuxIconInsertChart$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconInsertChart, defineCustomElement };
