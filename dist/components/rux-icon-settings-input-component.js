...
const RuxIconSettingsInputComponent$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
}, [0, "rux-icon-settings-input-component", {
    "size": [1]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-settings-input-component"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-settings-input-component":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconSettingsInputComponent$1);
      }
      break;
  } });
}

const RuxIconSettingsInputComponent = RuxIconSettingsInputComponent$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconSettingsInputComponent, defineCustomElement };
