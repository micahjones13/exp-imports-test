...
const RuxIconUsb$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-usb"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-usb":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconUsb$1);
      }
      break;
  } });
}

const RuxIconUsb = RuxIconUsb$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconUsb, defineCustomElement };
