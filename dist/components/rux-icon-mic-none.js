...
const RuxIconMicNone$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-mic-none"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-mic-none":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconMicNone$1);
      }
      break;
  } });
}

const RuxIconMicNone = RuxIconMicNone$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconMicNone, defineCustomElement };
