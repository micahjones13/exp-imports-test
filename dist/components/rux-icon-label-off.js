...
const RuxIconLabelOff$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-label-off"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-label-off":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconLabelOff$1);
      }
      break;
  } });
}

const RuxIconLabelOff = RuxIconLabelOff$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconLabelOff, defineCustomElement };
