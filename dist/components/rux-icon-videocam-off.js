...
const RuxIconVideocamOff$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-videocam-off"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-videocam-off":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconVideocamOff$1);
      }
      break;
  } });
}

const RuxIconVideocamOff = RuxIconVideocamOff$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconVideocamOff, defineCustomElement };
