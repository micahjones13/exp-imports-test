...
const RuxIconSdCard$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-sd-card"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-sd-card":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconSdCard$1);
      }
      break;
  } });
}

const RuxIconSdCard = RuxIconSdCard$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconSdCard, defineCustomElement };
