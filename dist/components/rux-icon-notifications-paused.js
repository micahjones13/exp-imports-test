...
const RuxIconNotificationsPaused$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
}, [0, "rux-icon-notifications-paused", {
    "size": [1]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-notifications-paused"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-notifications-paused":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconNotificationsPaused$1);
      }
      break;
  } });
}

const RuxIconNotificationsPaused = RuxIconNotificationsPaused$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconNotificationsPaused, defineCustomElement };
