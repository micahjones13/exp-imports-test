...
const RuxIconNotificationsActive$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
}, [0, "rux-icon-notifications-active", {
    "size": [1]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-notifications-active"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-notifications-active":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconNotificationsActive$1);
      }
      break;
  } });
}

const RuxIconNotificationsActive = RuxIconNotificationsActive$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconNotificationsActive, defineCustomElement };
