...
const RuxIconTonality$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-tonality"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-tonality":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconTonality$1);
      }
      break;
  } });
}

const RuxIconTonality = RuxIconTonality$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconTonality, defineCustomElement };
