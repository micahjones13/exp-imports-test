...
const RuxIconReportOff$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-report-off"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-report-off":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconReportOff$1);
      }
      break;
  } });
}

const RuxIconReportOff = RuxIconReportOff$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconReportOff, defineCustomElement };
