...
const RuxIconLayersClear$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-layers-clear"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-layers-clear":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconLayersClear$1);
      }
      break;
  } });
}

const RuxIconLayersClear = RuxIconLayersClear$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconLayersClear, defineCustomElement };
