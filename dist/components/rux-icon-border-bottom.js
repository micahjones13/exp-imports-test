...
const RuxIconBorderBottom$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-border-bottom"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-border-bottom":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconBorderBottom$1);
      }
      break;
  } });
}

const RuxIconBorderBottom = RuxIconBorderBottom$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconBorderBottom, defineCustomElement };
