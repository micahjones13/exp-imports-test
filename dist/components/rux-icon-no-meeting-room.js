...
const RuxIconNoMeetingRoom$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-no-meeting-room"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-no-meeting-room":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconNoMeetingRoom$1);
      }
      break;
  } });
}

const RuxIconNoMeetingRoom = RuxIconNoMeetingRoom$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconNoMeetingRoom, defineCustomElement };
