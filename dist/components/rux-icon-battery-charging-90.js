...
const RuxIconBatteryCharging90$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
}, [0, "rux-icon-battery-charging-90", {
    "size": [1]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-battery-charging-90"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-battery-charging-90":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconBatteryCharging90$1);
      }
      break;
  } });
}

const RuxIconBatteryCharging90 = RuxIconBatteryCharging90$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconBatteryCharging90, defineCustomElement };
