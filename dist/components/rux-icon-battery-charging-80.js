...
const RuxIconBatteryCharging80$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
}, [0, "rux-icon-battery-charging-80", {
    "size": [1]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-battery-charging-80"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-battery-charging-80":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconBatteryCharging80$1);
      }
      break;
  } });
}

const RuxIconBatteryCharging80 = RuxIconBatteryCharging80$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconBatteryCharging80, defineCustomElement };
