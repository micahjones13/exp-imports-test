...
const RuxIconBackup$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-backup"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-backup":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconBackup$1);
      }
      break;
  } });
}

const RuxIconBackup = RuxIconBackup$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconBackup, defineCustomElement };
