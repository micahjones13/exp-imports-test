...
const RuxIconHowToVote$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-how-to-vote"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-how-to-vote":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconHowToVote$1);
      }
      break;
  } });
}

const RuxIconHowToVote = RuxIconHowToVote$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconHowToVote, defineCustomElement };
