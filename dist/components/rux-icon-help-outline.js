...
const RuxIconHelpOutline$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-help-outline"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-help-outline":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconHelpOutline$1);
      }
      break;
  } });
}

const RuxIconHelpOutline = RuxIconHelpOutline$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconHelpOutline, defineCustomElement };
