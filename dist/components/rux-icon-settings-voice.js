...
const RuxIconSettingsVoice$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-settings-voice"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-settings-voice":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconSettingsVoice$1);
      }
      break;
  } });
}

const RuxIconSettingsVoice = RuxIconSettingsVoice$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconSettingsVoice, defineCustomElement };
