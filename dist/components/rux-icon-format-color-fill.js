...
const RuxIconFormatColorFill$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-format-color-fill"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-format-color-fill":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconFormatColorFill$1);
      }
      break;
  } });
}

const RuxIconFormatColorFill = RuxIconFormatColorFill$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconFormatColorFill, defineCustomElement };
