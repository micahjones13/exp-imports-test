...
const RuxIconCake$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-cake"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-cake":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconCake$1);
      }
      break;
  } });
}

const RuxIconCake = RuxIconCake$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconCake, defineCustomElement };
