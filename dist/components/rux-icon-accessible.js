...
const RuxIconAccessible$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-accessible"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-accessible":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconAccessible$1);
      }
      break;
  } });
}

const RuxIconAccessible = RuxIconAccessible$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconAccessible, defineCustomElement };
