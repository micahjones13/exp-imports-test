...
const RuxIconFlag$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-flag"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-flag":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconFlag$1);
      }
      break;
  } });
}

const RuxIconFlag = RuxIconFlag$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconFlag, defineCustomElement };
