...
const RuxIconFolderSpecial$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-folder-special"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-folder-special":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconFolderSpecial$1);
      }
      break;
  } });
}

const RuxIconFolderSpecial = RuxIconFolderSpecial$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconFolderSpecial, defineCustomElement };
