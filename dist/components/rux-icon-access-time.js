...
const RuxIconAccessTime$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-access-time"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-access-time":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconAccessTime$1);
      }
      break;
  } });
}

const RuxIconAccessTime = RuxIconAccessTime$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconAccessTime, defineCustomElement };
