...
const RuxIconSentimentSatisfied$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
}, [0, "rux-icon-sentiment-satisfied", {
    "size": [1]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-sentiment-satisfied"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-sentiment-satisfied":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconSentimentSatisfied$1);
      }
      break;
  } });
}

const RuxIconSentimentSatisfied = RuxIconSentimentSatisfied$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconSentimentSatisfied, defineCustomElement };
