...
const RuxIconPregnantWoman$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-pregnant-woman"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-pregnant-woman":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconPregnantWoman$1);
      }
      break;
  } });
}

const RuxIconPregnantWoman = RuxIconPregnantWoman$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconPregnantWoman, defineCustomElement };
