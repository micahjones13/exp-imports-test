...
const RuxIconLocalAirport$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-local-airport"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-local-airport":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconLocalAirport$1);
      }
      break;
  } });
}

const RuxIconLocalAirport = RuxIconLocalAirport$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconLocalAirport, defineCustomElement };
