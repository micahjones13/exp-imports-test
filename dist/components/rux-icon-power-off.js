...
const RuxIconPowerOff$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-power-off"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-power-off":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconPowerOff$1);
      }
      break;
  } });
}

const RuxIconPowerOff = RuxIconPowerOff$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconPowerOff, defineCustomElement };
