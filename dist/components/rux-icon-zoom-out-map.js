...
const RuxIconZoomOutMap$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-zoom-out-map"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-zoom-out-map":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconZoomOutMap$1);
      }
      break;
  } });
}

const RuxIconZoomOutMap = RuxIconZoomOutMap$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconZoomOutMap, defineCustomElement };
