...
const RuxIconSettingsBackupRestore$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
}, [0, "rux-icon-settings-backup-restore", {
    "size": [1]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-settings-backup-restore"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-settings-backup-restore":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconSettingsBackupRestore$1);
      }
      break;
  } });
}

const RuxIconSettingsBackupRestore = RuxIconSettingsBackupRestore$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconSettingsBackupRestore, defineCustomElement };
