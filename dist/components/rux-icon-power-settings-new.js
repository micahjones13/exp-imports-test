...
const RuxIconPowerSettingsNew$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-power-settings-new"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-power-settings-new":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconPowerSettingsNew$1);
      }
      break;
  } });
}

const RuxIconPowerSettingsNew = RuxIconPowerSettingsNew$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconPowerSettingsNew, defineCustomElement };
