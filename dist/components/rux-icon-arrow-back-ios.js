...
const RuxIconArrowBackIos$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-arrow-back-ios"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-arrow-back-ios":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconArrowBackIos$1);
      }
      break;
  } });
}

const RuxIconArrowBackIos = RuxIconArrowBackIos$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconArrowBackIos, defineCustomElement };
