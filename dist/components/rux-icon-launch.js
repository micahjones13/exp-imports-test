...
const RuxIconLaunch$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-launch"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-launch":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconLaunch$1);
      }
      break;
  } });
}

const RuxIconLaunch = RuxIconLaunch$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconLaunch, defineCustomElement };
