...
const RuxIconLanguage$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-language"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-language":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconLanguage$1);
      }
      break;
  } });
}

const RuxIconLanguage = RuxIconLanguage$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconLanguage, defineCustomElement };
