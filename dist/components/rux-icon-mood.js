...
const RuxIconMood$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-mood"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-mood":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconMood$1);
      }
      break;
  } });
}

const RuxIconMood = RuxIconMood$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconMood, defineCustomElement };
