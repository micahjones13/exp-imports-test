...
const RuxIconEventBusy$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-event-busy"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-event-busy":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconEventBusy$1);
      }
      break;
  } });
}

const RuxIconEventBusy = RuxIconEventBusy$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconEventBusy, defineCustomElement };
