...
const RuxIconDepartureBoard$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-departure-board"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-departure-board":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconDepartureBoard$1);
      }
      break;
  } });
}

const RuxIconDepartureBoard = RuxIconDepartureBoard$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconDepartureBoard, defineCustomElement };
