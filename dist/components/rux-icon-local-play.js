...
const RuxIconLocalPlay$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-local-play"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-local-play":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconLocalPlay$1);
      }
      break;
  } });
}

const RuxIconLocalPlay = RuxIconLocalPlay$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconLocalPlay, defineCustomElement };
