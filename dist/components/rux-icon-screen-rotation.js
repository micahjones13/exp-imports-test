...
const RuxIconScreenRotation$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-screen-rotation"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-screen-rotation":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconScreenRotation$1);
      }
      break;
  } });
}

const RuxIconScreenRotation = RuxIconScreenRotation$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconScreenRotation, defineCustomElement };
