...
const RuxIconWbAuto$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-wb-auto"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-wb-auto":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconWbAuto$1);
      }
      break;
  } });
}

const RuxIconWbAuto = RuxIconWbAuto$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconWbAuto, defineCustomElement };
