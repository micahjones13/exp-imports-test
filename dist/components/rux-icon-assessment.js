...
const RuxIconAssessment$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-assessment"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-assessment":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconAssessment$1);
      }
      break;
  } });
}

const RuxIconAssessment = RuxIconAssessment$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconAssessment, defineCustomElement };
