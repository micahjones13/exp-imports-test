...
const RuxIconColorLens$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-color-lens"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-color-lens":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconColorLens$1);
      }
      break;
  } });
}

const RuxIconColorLens = RuxIconColorLens$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconColorLens, defineCustomElement };
