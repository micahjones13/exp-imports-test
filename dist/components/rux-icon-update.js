...
const RuxIconUpdate$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-update"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-update":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconUpdate$1);
      }
      break;
  } });
}

const RuxIconUpdate = RuxIconUpdate$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconUpdate, defineCustomElement };
