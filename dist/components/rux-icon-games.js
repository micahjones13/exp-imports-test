...
const RuxIconGames$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-games"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-games":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconGames$1);
      }
      break;
  } });
}

const RuxIconGames = RuxIconGames$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconGames, defineCustomElement };
