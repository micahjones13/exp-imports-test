...
const RuxIconStarBorder$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-star-border"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-star-border":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconStarBorder$1);
      }
      break;
  } });
}

const RuxIconStarBorder = RuxIconStarBorder$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconStarBorder, defineCustomElement };
