...
const RuxIconFullscreen$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-fullscreen"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-fullscreen":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconFullscreen$1);
      }
      break;
  } });
}

const RuxIconFullscreen = RuxIconFullscreen$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconFullscreen, defineCustomElement };
