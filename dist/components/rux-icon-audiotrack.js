...
const RuxIconAudiotrack$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-audiotrack"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-audiotrack":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconAudiotrack$1);
      }
      break;
  } });
}

const RuxIconAudiotrack = RuxIconAudiotrack$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconAudiotrack, defineCustomElement };
