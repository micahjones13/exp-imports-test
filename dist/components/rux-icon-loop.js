...
const RuxIconLoop$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-loop"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-loop":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconLoop$1);
      }
      break;
  } });
}

const RuxIconLoop = RuxIconLoop$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconLoop, defineCustomElement };
