...
const RuxIconViewModule$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-view-module"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-view-module":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconViewModule$1);
      }
      break;
  } });
}

const RuxIconViewModule = RuxIconViewModule$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconViewModule, defineCustomElement };
