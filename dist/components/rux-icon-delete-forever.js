...
const RuxIconDeleteForever$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-delete-forever"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-delete-forever":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconDeleteForever$1);
      }
      break;
  } });
}

const RuxIconDeleteForever = RuxIconDeleteForever$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconDeleteForever, defineCustomElement };
