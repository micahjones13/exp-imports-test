...
const RuxIconSync$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-sync"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-sync":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconSync$1);
      }
      break;
  } });
}

const RuxIconSync = RuxIconSync$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconSync, defineCustomElement };
