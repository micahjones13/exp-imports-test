...
const RuxIconImage$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-image"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-image":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconImage$1);
      }
      break;
  } });
}

const RuxIconImage = RuxIconImage$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconImage, defineCustomElement };
