...
const RuxIconStayPrimaryPortrait$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    /**
...
}, [0, "rux-icon-stay-primary-portrait", {
    "size": [1]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["rux-icon-stay-primary-portrait"];
  components.forEach(tagName => { switch (tagName) {
    case "rux-icon-stay-primary-portrait":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, RuxIconStayPrimaryPortrait$1);
      }
      break;
  } });
}

const RuxIconStayPrimaryPortrait = RuxIconStayPrimaryPortrait$1;
const defineCustomElement = defineCustomElement$1;

export { RuxIconStayPrimaryPortrait, defineCustomElement };
